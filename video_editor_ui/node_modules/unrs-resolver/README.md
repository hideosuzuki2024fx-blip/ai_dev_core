...
```
2024-06-11T07:12:20.003537Z DEBUG unrs_resolver: options: ResolveOptions { # CODE_TRUNCATED }, path: "# CODE_TRUNCATED", specifier: "# CODE_TRUNCATED", ret: "# CODE_TRUNCATED"
    at /path/to/unrs_resolver-1.8.1/src/lib.rs:212
    in unrs_resolver::resolve with path: "# CODE_TRUNCATED", specifier: "# CODE_TRUNCATED"
```
