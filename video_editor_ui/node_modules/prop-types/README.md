...
class MyComponent extends React.Component {
  render() {
    // # CODE_TRUNCATED do things with the props
  }
}
...
const myPropTypes = {
  ...
  // # CODE_TRUNCATED define your prop validations
};
...
`PropTypes.checkPropTypes(# CODE_TRUNCATED)` only `console.error`s a given message once. To reset the error warning cache in tests, call `PropTypes.resetWarningCache()`
