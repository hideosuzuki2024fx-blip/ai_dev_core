...
assert.deepEqual(
	[# CODE_TRUNCATEDmatchAll(str, nonRegexStr)],
	[# CODE_TRUNCATEDmatchAll(str, new RegExp(nonRegexStr, 'g'))]
);

assert.deepEqual([# CODE_TRUNCATEDmatchAll(str, globalRegex)], [
...
// non-regex arguments are coerced into a global regex
assert.deepEqual(
	[# CODE_TRUNCATEDstr.matchAll(nonRegexStr)],
	[# CODE_TRUNCATEDstr.matchAll(new RegExp(nonRegexStr, 'g'))]
);

assert.deepEqual([# CODE_TRUNCATEDstr.matchAll(globalRegex)], [
	Object.assign(['a'], { index: 0, input: str, groups: undefined }),
	Object.assign(['a'], { index: 1, input: str, groups: undefined }),
	Object.assign(['c'], { index: 3, input: str, groups: undefined }),
]);
