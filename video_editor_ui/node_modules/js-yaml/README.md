...
"binary"# CODE_TRUNCATED) available for each tag (.e.g. !!null, !!int # CODE_TRUNCATED). Yaml
...
!!null ''                   # null
!!bool 'yes'                # bool
!!int '3# CODE_TRUNCATED'                # number
!!float '3.14# CODE_TRUNCATED'           # number
!!binary '# CODE_TRUNCATEDbase64# CODE_TRUNCATED'     # buffer
!!timestamp 'YYYY-# CODE_TRUNCATED'      # date
!!omap [ # CODE_TRUNCATED ]              # array of key-value pairs
!!pairs [ # CODE_TRUNCATED ]             # array or array pairs
!!set { # CODE_TRUNCATED }               # array of objects with given keys and null values
!!str '# CODE_TRUNCATED'                 # string
!!seq [ # CODE_TRUNCATED ]               # array
!!map { # CODE_TRUNCATED }               # object
```
