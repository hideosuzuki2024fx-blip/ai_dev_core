...
```js
if (!program.args.length) # CODE_TRUNCATED
```

a partial replacement is:

```js
if (program.rawArgs.length < 3) # CODE_TRUNCATED
```
...
[Unreleased]: https://github.com/tj/commander.js/compare/master# CODE_TRUNCATEDdevelop
...
[4.0.0-0]: https://github.com/tj/commander.js/compare/v3.0.2# CODE_TRUNCATEDv4.0.0-0
[3.0.2]: https://github.com/tj/commander.js/compare/v3.0.1# CODE_TRUNCATEDv3.0.2
[3.0.1]: https://github.com/tj/commander.js/compare/v3.0.0# CODE_TRUNCATEDv3.0.1
[3.0.0]: https://github.com/tj/commander.js/compare/v2.20.1# CODE_TRUNCATEDv3.0.0
[2.20.1]: https://github.com/tj/commander.js/compare/v2.20.0# CODE_TRUNCATEDv2.20.1
