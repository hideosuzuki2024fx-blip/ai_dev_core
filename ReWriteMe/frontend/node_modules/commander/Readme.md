...
```
 ...
 append `# CODE_TRUNCATED` to the argument name. For example:
...
program
  .version('0.1.0')
  .command('rmdir <dir> [otherDirs# CODE_TRUNCATED]')
...
try {
  ...
  // custom processing# CODE_TRUNCATED
}
```
