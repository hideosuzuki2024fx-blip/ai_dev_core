...
Returns source map converter from given base64 or uri encoded json string prefixed with `//# sourceMappingURL=# CODE_TRUNCATED`.
...
By default, the comment is formatted like: `//# sourceMappingURL=# CODE_TRUNCATED`, which you would
normally see in a JS source file.

When `options.encoding == 'uri'`, the data will be uri encoded, otherwise they will be base64 encoded.

When `options.multiline == true`, the comment is formatted like: `/*# sourceMappingURL=# CODE_TRUNCATED */`, which you would find in a CSS source file.
...
By default, the comment is formatted like: `//# sourceMappingURL=# CODE_TRUNCATED`, which you would normally see in a JS source file.
