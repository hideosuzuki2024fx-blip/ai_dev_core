...
1.  **First of all, make sure you're doing it right.** A type error could also indicate that you're not :wink:
    ...
    - If you're using TypeScript, [type widening](https://blog.mariusschulz.com/2017/02/04/TypeScript-2-1-literal-type-widening) could be the reason you get `Type 'string' is not assignable to# CODE_TRUNCATED` errors
    ...
    - The recommended way is to use **module augmentation**. Here's a few examples:
      ...
      declare module 'csstype' {
        interface Properties {
          ...
          // # CODE_TRUNCATEDor allow any other property
          [index: string]: any;
        }
      }
      ```
