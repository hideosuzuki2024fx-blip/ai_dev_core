...
def _unwrapped_call(call: Optional[Callable[# CODE_TRUNCATED, Any]]) -> Any:
    if call is None:
...
def _impartial(func: Callable[# CODE_TRUNCATED, Any]) -> Callable[# CODE_TRUNCATED, Any]:
...
class Dependant:
    ...
    call: Optional[Callable[# CODE_TRUNCATED, Any]] = None
