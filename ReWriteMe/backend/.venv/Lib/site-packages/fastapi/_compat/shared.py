...
if sys.version_info < (3, 10):
    WithArgsTypes: tuple[Any, # CODE_TRUNCATED] = (typing._GenericAlias, types.GenericAlias)  # type: ignore[attr-defined]
else:
    WithArgsTypes: tuple[Any, # CODE_TRUNCATED] = (
...
def lenient_issubclass(
    cls: Any, class_or_tuple: Union[type[Any], tuple[type[Any], # CODE_TRUNCATED], None]
) -> bool:
    try:
...
def field_annotation_is_scalar(annotation: Any) -> bool:
    # handle Ellipsis here to make tuple[int, # CODE_TRUNCATED] work nicely
