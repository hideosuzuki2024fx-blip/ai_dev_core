...
class ModelField:
    ...
    def validate(
        ...
        *,
        loc: tuple[Union[int, str], # CODE_TRUNCATED] = (),
...
def get_missing_field_error(loc: tuple[str, # CODE_TRUNCATED]) -> dict[str, Any]:
...
def _regenerate_error_with_loc(
    *, errors: Sequence[Any], loc_prefix: tuple[Union[str, int], # CODE_TRUNCATED]
) -> list[dict[str, Any]]:
