...
class AsyncHTTP2Connection(AsyncConnectionInterface):
    ...
    # Sending the request# CODE_TRUNCATED
    ...
    # Receiving the response# CODE_TRUNCATED
    ...
    # Wrappers around network read/write operations# CODE_TRUNCATED
    ...
    # Interface for connection pooling# CODE_TRUNCATED
