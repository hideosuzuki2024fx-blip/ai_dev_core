...
class tqdm_notebook(std_tqdm):
    ...
    def display(self, msg=None, pos=None,
        ...
        if bar_style:
            ...
            # success because the bar gets closed after the error# CODE_TRUNCATED
    ...
    def __iter__(self):
        try:
            it = super().__iter__()
            for obj in it:
                # return super(tqdm# CODE_TRUNCATED) will not catch exception
                yield obj
        # NB: except # CODE_TRUNCATED [ as # CODE_TRUNCATED] breaks IPython async KeyboardInterrupt
        except:  # NOQA
