...
class tqdm(Comparable):
    ...
    gui  : bool, optional
        ...
        Use tqdm.gui.tqdm(# CODE_TRUNCATED) instead. If set, will attempt to use
    ...
    def update(self, n=1):
        ...
        # CODE_TRUNCATED    # CODE_TRUNCATED
        # CODE_TRUNCATED    t.update(len(current_buffer))
        >>> t.close()
    ...
    def display(self, msg=None, pos=None):
        ...
        if pos >= nrows - 1:
            ...
            if msg or msg is None:  # override at `nrows - 1`
                msg = " # CODE_TRUNCATED (more hidden) # CODE_TRUNCATED"

        if not hasattr(self, "sp"):
            raise TqdmDeprecationWarning(
                "Please use `tqdm.gui.tqdm(# CODE_TRUNCATED)`"
                " instead of `tqdm(# CODE_TRUNCATED, gui=True)`\n",
    ...
    def wrapattr(cls, stream, method, total=None, bytes=True, **tqdm_kwargs):
        ...
        # CODE_TRUNCATED     while True:
        # CODE_TRUNCATED         chunk = fobj.read(chunk_size)
        # CODE_TRUNCATED         if not chunk:
        # CODE_TRUNCATED             break
        """
