...
class AsyncIODBAPIConnection(Protocol):
    ...
    async def commit(self) -> None: # CODE_TRUNCATED

    def cursor(self, *args: Any, **kwargs: Any) -> AsyncIODBAPICursor: # CODE_TRUNCATED

    async def rollback(self) -> None: # CODE_TRUNCATED
...
class AsyncIODBAPICursor(Protocol):
    ...
    def __aenter__(self) -> Any: # CODE_TRUNCATED
    ...
    async def close(self) -> None: # CODE_TRUNCATED
    ...
    async def fetchone(self) -> Optional[Any]: # CODE_TRUNCATED

    async def fetchmany(self, size: Optional[int] = # CODE_TRUNCATED) -> Sequence[Any]: # CODE_TRUNCATED

    async def fetchall(self) -> Sequence[Any]: # CODE_TRUNCATED

    async def setinputsizes(self, sizes: Sequence[Any]) -> None: # CODE_TRUNCATED
    ...
    async def nextset(self) -> Optional[bool]: # CODE_TRUNCATED

    def __aiter__(self) -> AsyncIterator[Any]: # CODE_TRUNCATED
...
class AsyncAdapt_terminate:
    ...
    def _terminate_handled_exceptions(self) -> Tuple[Type[BaseException], # CODE_TRUNCATED]:
