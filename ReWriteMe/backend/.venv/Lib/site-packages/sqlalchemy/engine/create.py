...
def create_engine(
    url: Union[str, URL],
    *,
    connect_args: Dict[Any, Any] = # CODE_TRUNCATED,
    convert_unicode: bool = # CODE_TRUNCATED,
    creator: Union[_CreatorFnType, _CreatorWRecFnType] = # CODE_TRUNCATED,
    echo: _EchoFlagType = # CODE_TRUNCATED,
    echo_pool: _EchoFlagType = # CODE_TRUNCATED,
    enable_from_linting: bool = # CODE_TRUNCATED,
    execution_options: _ExecuteOptions = # CODE_TRUNCATED,
    future: Literal[True],
    hide_parameters: bool = # CODE_TRUNCATED,
    implicit_returning: Literal[True] = # CODE_TRUNCATED,
    insertmanyvalues_page_size: int = # CODE_TRUNCATED,
    isolation_level: IsolationLevel = # CODE_TRUNCATED,
    json_deserializer: Callable[# CODE_TRUNCATED, Any] = # CODE_TRUNCATED,
    json_serializer: Callable[# CODE_TRUNCATED, Any] = # CODE_TRUNCATED,
    label_length: Optional[int] = # CODE_TRUNCATED,
    logging_name: str = # CODE_TRUNCATED,
    max_identifier_length: Optional[int] = # CODE_TRUNCATED,
    max_overflow: int = # CODE_TRUNCATED,
    module: Optional[Any] = # CODE_TRUNCATED,
    paramstyle: Optional[_ParamStyle] = # CODE_TRUNCATED,
    pool: Optional[Pool] = # CODE_TRUNCATED,
    poolclass: Optional[Type[Pool]] = # CODE_TRUNCATED,
    pool_logging_name: str = # CODE_TRUNCATED,
    pool_pre_ping: bool = # CODE_TRUNCATED,
    pool_size: int = # CODE_TRUNCATED,
    pool_recycle: int = # CODE_TRUNCATED,
    pool_reset_on_return: Optional[_ResetStyleArgType] = # CODE_TRUNCATED,
    pool_timeout: float = # CODE_TRUNCATED,
    pool_use_lifo: bool = # CODE_TRUNCATED,
    plugins: List[str] = # CODE_TRUNCATED,
    query_cache_size: int = # CODE_TRUNCATED,
    use_insertmanyvalues: bool = # CODE_TRUNCATED,
    **kwargs: Any,
) -> Engine: # CODE_TRUNCATED


@overload
def create_engine(url: Union[str, URL], **kwargs: Any) -> Engine: # CODE_TRUNCATED
...
def create_pool_from_url(
    ...
    *,
    poolclass: Optional[Type[Pool]] = # CODE_TRUNCATED,
    logging_name: str = # CODE_TRUNCATED,
    pre_ping: bool = # CODE_TRUNCATED,
    size: int = # CODE_TRUNCATED,
    recycle: int = # CODE_TRUNCATED,
    reset_on_return: Optional[_ResetStyleArgType] = # CODE_TRUNCATED,
    timeout: float = # CODE_TRUNCATED,
    use_lifo: bool = # CODE_TRUNCATED,
    **kwargs: Any,
) -> Pool: # CODE_TRUNCATED


@overload
def create_pool_from_url(url: Union[str, URL], **kwargs: Any) -> Pool: # CODE_TRUNCATED
