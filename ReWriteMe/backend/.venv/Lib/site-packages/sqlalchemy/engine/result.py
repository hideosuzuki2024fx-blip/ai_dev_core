...
_RawRowType = Tuple[Any, # CODE_TRUNCATED]
...
class ResultMetaData:
    ...
    @overload
    def _key_fallback(
        self, key: Any, err: Optional[Exception], raiseerr: Literal[True] = # CODE_TRUNCATED
    ...
    def _key_fallback(
        ...
        raiseerr: Literal[False] = # CODE_TRUNCATED,
    ) -> None: # CODE_TRUNCATED

    @overload
    def _key_fallback(
        self, key: Any, err: Optional[Exception], raiseerr: bool = # CODE_TRUNCATED
    ) -> Optional[NoReturn]: # CODE_TRUNCATED
...
class ResultInternal(InPlaceGenerative, Generic[_R]):
    ...
    def _row_getter(self) -> Optional[Callable[# CODE_TRUNCATED, _R]]:
        ...
        if tf and not real_result._source_supports_scalars:
            ...
            _make_row_orig: Callable[# CODE_TRUNCATED, _R] = functools.partial(  # type: ignore  # noqa E501
    ...
    @HasMemoized_ro_memoized_attribute
    def _iterator_getter(self) -> Callable[# CODE_TRUNCATED, Iterator[_R]]:
    ...
    def _onerow_getter(
        self,
    ) -> Callable[# CODE_TRUNCATED, Union[Literal[_NoRow._NO_ROW], _R]]:
        make_row = self._row_getter
    ...
    @HasMemoized_ro_memoized_attribute
    def _manyrow_getter(self) -> Callable[# CODE_TRUNCATED, List[_R]]:
        make_row = self._row_getter
        ...
        if self._unique_filter_state:
            ...
            def filterrows(
                make_row: Optional[Callable[# CODE_TRUNCATED, _R]],
                rows: List[Any],
...
class Result(_WithKeys, ResultInternal[Row[_TP]]):
    ...
    @overload
    def scalars(self: Result[Tuple[_T]]) -> ScalarResult[_T]: # CODE_TRUNCATED
    ...
    @overload
    def scalars(self, index: _KeyIndexType = 0) -> ScalarResult[Any]: # CODE_TRUNCATED
    ...
    @overload
    def scalar_one(self: Result[Tuple[_T]]) -> _T: # CODE_TRUNCATED

    @overload
    def scalar_one(self) -> Any: # CODE_TRUNCATED
    ...
    @overload
    def scalar_one_or_none(self: Result[Tuple[_T]]) -> Optional[_T]: # CODE_TRUNCATED

    @overload
    def scalar_one_or_none(self) -> Optional[Any]: # CODE_TRUNCATED
    ...
    @overload
    def scalar(self: Result[Tuple[_T]]) -> Optional[_T]: # CODE_TRUNCATED

    @overload
    def scalar(self) -> Any: # CODE_TRUNCATED
...
class TupleResult(FilterResult[_R], util.TypingOnly):
    ...
    if TYPE_CHECKING:
        ...
        def __iter__(self) -> Iterator[_R]: # CODE_TRUNCATED

        def __next__(self) -> _R: # CODE_TRUNCATED
        ...
        @overload
        def scalar_one(self: TupleResult[Tuple[_T]]) -> _T: # CODE_TRUNCATED
        ...
        @overload
        def scalar(self: TupleResult[Tuple[_T]]) -> Optional[_T]: # CODE_TRUNCATED
