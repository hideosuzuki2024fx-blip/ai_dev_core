...
class Row(BaseRow, Sequence[Any], Generic[_TP]):
    ...
    if TYPE_CHECKING:
        ...
        @overload
        def __getitem__(self, index: int) -> Any: # CODE_TRUNCATED

        @overload
        def __getitem__(self, index: slice) -> Sequence[Any]: # CODE_TRUNCATED

        def __getitem__(self, index: Union[int, slice]) -> Any: # CODE_TRUNCATED
    ...
    @property
    def _fields(self) -> Tuple[str, # CODE_TRUNCATED]:
...
class RowMapping(BaseRow, typing.Mapping["_KeyType", Any]):
    ...
    if TYPE_CHECKING:
        ...
        def __getitem__(self, key: _KeyType) -> Any: # CODE_TRUNCATED
