...
) -> Callable[[Callable[# CODE_TRUNCATED, _R]], Callable[# CODE_TRUNCATED, _R]]:
    @util.decorator
    def go(
        fn: Callable[# CODE_TRUNCATED, _R],
        self: Dialect,
...
class Inspector(inspection.Inspectable["Inspector"]):
    ...
    or a :class:`_engine.Connection`::
        ...
        engine = create_engine("# CODE_TRUNCATED")
        insp = inspect(engine)
    ...
    @classmethod
    def _construct(
        cls, init: Callable[# CODE_TRUNCATED, Any], bind: Union[Engine, Connection]
    ) -> Inspector:
    ...
    def get_sorted_table_and_fkc_names(
        ...
        **kw: Any,
        ...
        ``(tablename, [(tname, fkname), (tname, fkname), # CODE_TRUNCATED])``
