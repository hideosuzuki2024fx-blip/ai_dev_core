            ...
            if is_returning:
                ...
                if imv.num_sentinel_columns and not imv_batch.is_downgraded:
                    ...
                    rows_by_sentinel: Union[
                        Dict[Tuple[Any, # CODE_TRUNCATED], Any],
                        Dict[Any, Any],
                    ]
                    if composite_sentinel:
                        rows_by_sentinel = {
    ...
    def _default_multi_reflect(
        ...
        **kw,
        ...
        if (
            ...
            # (i.e. the Table(# CODE_TRUNCATED, autoload) case), take the names as given,
...
class DefaultExecutionContext(ExecutionContext):
    ...
    _insertmanyvalues_rows: Optional[List[Tuple[Any, # CODE_TRUNCATED]]] = None
    ...
    def _prepare_set_input_sizes(
        ...
        # all of the rest of this# CODE_TRUNCATED cython?
