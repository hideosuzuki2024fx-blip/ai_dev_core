...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    @overload
    def execution_options(self, **opt: Any) -> Connection: # CODE_TRUNCATED
    ...
    def begin_nested(self) -> NestedTransaction:
        ...
        outer transaction. E.g.::
            ...
            with engine.begin() as connection:
                ...
                connection.execute(# CODE_TRUNCATED)
    ...
    def _execute_context(
        self,
        dialect: Dialect,
        constructor: Callable[# CODE_TRUNCATED, ExecutionContext],
...
class RootTransaction(Transaction):
    ...
    def _do_commit(self) -> None:
        if self.is_active:
            ...
            # # CODE_TRUNCATEDhowever only remove as the connection's current transaction
...
class Engine(
    ...
    def execution_options(
        ...
        *,
        ...
        schema_translate_map: Optional[SchemaTranslateMapType] = # CODE_TRUNCATED,
        **opt: Any,
    ) -> OptionEngine: # CODE_TRUNCATED

    @overload
    def execution_options(self, **opt: Any) -> OptionEngine: # CODE_TRUNCATED
