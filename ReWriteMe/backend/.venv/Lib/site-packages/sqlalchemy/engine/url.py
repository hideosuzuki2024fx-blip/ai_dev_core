...
class URL(NamedTuple):
    ...
    * :attr:`_engine.URL.query`: an immutable mapping representing the query
    ...
    query: util.immutabledict[str, Union[Tuple[str, # CODE_TRUNCATED], str]]
    """an immutable mapping representing the query string.  contains strings
       for keys and either strings or tuples of strings for values, e.g.::
            ...
            >>> url = make_url(
            # CODE_TRUNCATED     "postgresql+psycopg2://user:pass@host/dbname?alt_host=host1&alt_host=host2&ssl_cipher=%2Fpath%2Fto%2Fcrt"
            # CODE_TRUNCATED )
            >>> url.query
    ...
    def _str_dict(
    ...
    ) -> util.immutabledict[str, Union[Tuple[str, # CODE_TRUNCATED], str]]:
        if dict_ is None:
        ...
        def _assert_value(
            val: Sequence[str],
        ) -> Union[str, Tuple[str, # CODE_TRUNCATED]]: # CODE_TRUNCATED

        def _assert_value(
            val: Union[str, Sequence[str]],
        ) -> Union[str, Tuple[str, # CODE_TRUNCATED]]:
    ...
    def update_query_string(
        ...
        E.g.::
            ...
            # CODE_TRUNCATED     "alt_host=host1&alt_host=host2&ssl_cipher=%2Fpath%2Fto%2Fcrt"
            # CODE_TRUNCATED )
            >>> str(url)
    ...
    def update_query_pairs(
        ...
        E.g.::
            ...
            # CODE_TRUNCATED     [
            # CODE_TRUNCATED         ("alt_host", "host1"),
            # CODE_TRUNCATED         ("alt_host", "host2"),
            # CODE_TRUNCATED         ("ssl_cipher", "/path/to/crt"),
            # CODE_TRUNCATED     ]
            # CODE_TRUNCATED )
            >>> str(url)
            'postgresql+psycopg2://user:pass@host/dbname?alt_host=host1&alt_host=host2&ssl_cipher=%2Fpath%2Fto%2Fcrt'
    ...
    def update_query_dict(
        ...
        E.g.::
            ...
            # CODE_TRUNCATED     {"alt_host": ["host1", "host2"], "ssl_cipher": "/path/to/crt"}
            # CODE_TRUNCATED )
            >>> str(url)
            'postgresql+psycopg2://user:pass@host/dbname?alt_host=host1&alt_host=host2&ssl_cipher=%2Fpath%2Fto%2Fcrt'
