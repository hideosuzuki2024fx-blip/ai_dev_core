...
_LambdaCacheType = MutableMapping[
    Tuple[Any, # CODE_TRUNCATED], Union["NonAnalyzedFunction", "AnalyzedFunction"]
]
_BoundParameterGetter = Callable[# CODE_TRUNCATED, Any]
...
_AnyLambdaType = Callable[# CODE_TRUNCATED, Any]
...
class LambdaElement(elements.ClauseElement):
    ...
    _transforms: Tuple[_CloneCallableType, # CODE_TRUNCATED] = ()

    _resolved_bindparams: List[BindParameter[Any]]
    parent_lambda: Optional[StatementLambdaElement] = None
    closure_cache_key: Union[Tuple[Any, # CODE_TRUNCATED], Literal[CacheConst.NO_CACHE]]
    role: Type[SQLRole]
    _rec: Union[AnalyzedFunction, NonAnalyzedFunction]
    fn: _AnyLambdaType
    tracker_key: Tuple[CodeType, # CODE_TRUNCATED]
    ...
    def _retrieve_tracker_rec(self, fn, apply_propagate_attrs, opts):
        ...
        cache_key: Union[Tuple[Any, # CODE_TRUNCATED], Literal[CacheConst.NO_CACHE]]
    ...
    def _gen_cache_key(self, anon_map, bindparams):
        ...
        while parent is not None:
            ...
            parent_closure_cache_key: Tuple[Any, # CODE_TRUNCATED] = (
...
class DeferredLambdaElement(LambdaElement):
    ...
    def __init__(
        ...
        opts: Union[Type[LambdaOptions], LambdaOptions] = LambdaOptions,
        lambda_args: Tuple[Any, # CODE_TRUNCATED] = (),
    ):
...
class StatementLambdaElement(
    ...
    def add_criteria(
        ...
        E.g.::
            ...
            # CODE_TRUNCATED     stmt = lambda_stmt(
            # CODE_TRUNCATED         lambda: select(table.c.x, table.c.y),
            # CODE_TRUNCATED     )
            # CODE_TRUNCATED     stmt = stmt.add_criteria(lambda: table.c.x > parameter)
            # CODE_TRUNCATED     return stmt
        ...
        ``track_closure_values`` and ``track_on``::
            ...
            # CODE_TRUNCATED     stmt = lambda_stmt(
            # CODE_TRUNCATED         lambda: select(func.max(foo.x, foo.y)),
            # CODE_TRUNCATED         track_closure_variables=False,
            # CODE_TRUNCATED     )
            # CODE_TRUNCATED     stmt = stmt.add_criteria(lambda: self.where_criteria, track_on=[self])
            # CODE_TRUNCATED     return stmt
