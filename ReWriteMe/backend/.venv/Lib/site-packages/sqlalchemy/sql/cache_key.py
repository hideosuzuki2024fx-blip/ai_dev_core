...
class _CacheKeyTraversalDispatchType(Protocol):
    ...
    ) -> _CacheKeyTraversalDispatchTypeReturn: # CODE_TRUNCATED
...
_CacheKeyTraversalDispatchTypeReturn = Sequence[
    Tuple[
        ...
        Any,
        Union[
            Callable[# CODE_TRUNCATED, Tuple[Any, # CODE_TRUNCATED]],
            CacheTraverseTarget,
            InternalTraversal,
        ],
    ]
...
class HasCacheKey:
    ...
    def _gen_cache_key(
    ...
    ) -> Optional[Tuple[Any, # CODE_TRUNCATED]]:
        ...
        result: Tuple[Any, # CODE_TRUNCATED] = (id_, cls)
...
class CacheKey(NamedTuple):
    ...
    def __str__(self) -> str:
        stack: List[Union[Tuple[Any, # CODE_TRUNCATED], HasCacheKey]] = [self.key]
...
def _ad_hoc_cache_key_from_args(
    tokens: Tuple[Any, # CODE_TRUNCATED],
