...
class Integer(HasExpressionLookup, TypeEngine[int]):
    ...
    if TYPE_CHECKING:
        ...
        def _type_affinity(self) -> Type[Integer]: # CODE_TRUNCATED
...
class Numeric(HasExpressionLookup, TypeEngine[_N]):
    ...
    if TYPE_CHECKING:
        ...
        @util.ro_memoized_property
        def _type_affinity(self) -> Type[Numeric[_N]]: # CODE_TRUNCATED
    ...
    def __init__(
        ...
        precision: Optional[int] = # CODE_TRUNCATED,
        scale: Optional[int] = # CODE_TRUNCATED,
        decimal_return_scale: Optional[int] = # CODE_TRUNCATED,
        asdecimal: Literal[True] = # CODE_TRUNCATED,
    ): # CODE_TRUNCATED
    ...
    def __init__(
        ...
        scale: Optional[int] = # CODE_TRUNCATED,
        decimal_return_scale: Optional[int] = # CODE_TRUNCATED,
        asdecimal: Literal[False] = # CODE_TRUNCATED,
    ): # CODE_TRUNCATED
...
class SchemaType(SchemaEventTarget, TypeEngineMixin):
    ...
    @overload
    def adapt(self, cls: Type[_TE], **kw: Any) -> _TE: # CODE_TRUNCATED

    @overload
    def adapt(
        self, cls: Type[TypeEngineMixin], **kw: Any
    ) -> TypeEngine[Any]: # CODE_TRUNCATED
...
class Enum(String, SchemaType, Emulated, TypeEngine[Union[str, enum.Enum]]):
    ...
    @overload
    def __init__(self, enums: Type[enum.Enum], **kw: Any) -> None: # CODE_TRUNCATED

    @overload
    def __init__(self, *enums: str, **kw: Any) -> None: # CODE_TRUNCATED
...
class JSON(Indexable, TypeEngine[Any]):
    ...
    * Path index operations::
        ...
        data_table.c.data[("key_1", "key_2", 5, # CODE_TRUNCATED, "key_n")]
...
class ARRAY(
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    class Comparator(
        ...
        def _setup_getitem(
            self, index: int
        ) -> Tuple[OperatorType, int, TypeEngine[Any]]: # CODE_TRUNCATED

        @overload
        def _setup_getitem(
            self, index: slice
        ) -> Tuple[OperatorType, Slice, TypeEngine[Any]]: # CODE_TRUNCATED
...
class TupleType(TypeEngine[Tuple[Any, # CODE_TRUNCATED]]):
...
class Uuid(Emulated, TypeEngine[_UUID_RETURN]):
    ...
    **Python uuid objects**, from the Python
    ...
    def __init__(
        ...
        as_uuid: Literal[True] = # CODE_TRUNCATED,
        native_uuid: bool = # CODE_TRUNCATED,
    ): # CODE_TRUNCATED

    @overload
    def __init__(
        self: Uuid[str],
        as_uuid: Literal[False] = # CODE_TRUNCATED,
        native_uuid: bool = # CODE_TRUNCATED,
    ): # CODE_TRUNCATED
...
class UUID(Uuid[_UUID_RETURN], type_api.NativeForEmulated):
    ...
    @overload
    def __init__(self: UUID[_python_UUID], as_uuid: Literal[True] = # CODE_TRUNCATED): # CODE_TRUNCATED

    @overload
    def __init__(self: UUID[str], as_uuid: Literal[False] = # CODE_TRUNCATED): # CODE_TRUNCATED
