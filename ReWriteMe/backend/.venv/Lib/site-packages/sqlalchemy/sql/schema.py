...
class Table(
    ...
    if TYPE_CHECKING:
        ...
        def primary_key(self) -> PrimaryKeyConstraint: # CODE_TRUNCATED

        @util.ro_non_memoized_property
        def foreign_keys(self) -> Set[ForeignKey]: # CODE_TRUNCATED
    ...
    if TYPE_CHECKING:
        ...
        @util.ro_non_memoized_property
        def columns(self) -> ReadOnlyColumnCollection[str, Column[Any]]: # CODE_TRUNCATED

        @util.ro_non_memoized_property
        def exported_columns(
            self,
        ) -> ReadOnlyColumnCollection[str, Column[Any]]: # CODE_TRUNCATED

        @util.ro_non_memoized_property
        def c(self) -> ReadOnlyColumnCollection[str, Column[Any]]: # CODE_TRUNCATED

    def _gen_cache_key(
        self, anon_map: anon_map, bindparams: List[BindParameter[Any]]
    ) -> Tuple[Any, # CODE_TRUNCATED]:
    ...
    def __init__(
        ...
        *args: SchemaItem,
        ...
        listeners: Optional[
            _typing_Sequence[Tuple[str, Callable[# CODE_TRUNCATED, Any]]]
        ] = None,
...
class Column(DialectKWArgs, SchemaItem, ColumnClause[_T]):
    ...
    def _setup_on_memoized_fks(self, fn: Callable[# CODE_TRUNCATED, Any]) -> None:
        fk_keys = [
    ...
    def _on_table_attach(self, fn: Callable[# CODE_TRUNCATED, Any]) -> None:
...
class ForeignKey(DialectKWArgs, SchemaItem):
    ...
    @overload
    def _resolve_column(
        self, *, raiseerr: Literal[True] = # CODE_TRUNCATED
    ) -> Column[Any]: # CODE_TRUNCATED

    @overload
    def _resolve_column(
        self, *, raiseerr: bool = # CODE_TRUNCATED
    ) -> Optional[Column[Any]]: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    ) -> TypeGuard[Sequence]: # CODE_TRUNCATED

    def default_is_clause_element(
        obj: Optional[DefaultGenerator],
    ) -> TypeGuard[ColumnElementColumnDefault]: # CODE_TRUNCATED

    def default_is_scalar(
        obj: Optional[DefaultGenerator],
    ) -> TypeGuard[ScalarElementColumnDefault]: # CODE_TRUNCATED
...
class ColumnDefault(DefaultGenerator, ABC):
    ...
    @overload
    def __new__(
        cls, arg: Callable[# CODE_TRUNCATED, Any], for_update: bool = # CODE_TRUNCATED
    ) -> CallableColumnDefault: # CODE_TRUNCATED

    @overload
    def __new__(
        cls, arg: ColumnElement[Any], for_update: bool = # CODE_TRUNCATED
    ) -> ColumnElementColumnDefault: # CODE_TRUNCATED
    ...
    @overload
    def __new__(cls, arg: object, for_update: bool = # CODE_TRUNCATED) -> ColumnDefault: # CODE_TRUNCATED
...
class _CallableColumnDefaultProtocol(Protocol):
    def __call__(self, context: ExecutionContext) -> Any: # CODE_TRUNCATED
...
class ForeignKeyConstraint(ColumnCollectionConstraint):
    ...
    Defines a single column or composite FOREIGN KEY # CODE_TRUNCATED REFERENCES
...
class PrimaryKeyConstraint(ColumnCollectionConstraint):
    ...
    the :paramref:`_schema.Column.primary_key` flag::
        ...
        >>> my_table = Table(
        # CODE_TRUNCATED     "mytable",
        # CODE_TRUNCATED     metadata,
        # CODE_TRUNCATED     Column("id", Integer, primary_key=True),
        # CODE_TRUNCATED     Column("version_id", Integer, primary_key=True),
        # CODE_TRUNCATED     Column("data", String(50)),
        # CODE_TRUNCATED )
...
class MetaData(HasSchemaAttr):
          ...
          * the string name of a user-defined "token" that can be used
          ...
          available for certain types of constraint:
            ...
            * ``%(referred_column_0_name)s``, ``%(referred_column_0N_name)s``
              ...
              ``%(referred_column_0N_key)s``, # CODE_TRUNCATED  column tokens which
    ...
    def reflect(
        self,
        bind: Engine,
        schema: Optional[str] = # CODE_TRUNCATED,
        views: bool = # CODE_TRUNCATED,
        only: Union[
            _typing_Sequence[str], Callable[[str, MetaData], bool], None
        ] = # CODE_TRUNCATED,
        extend_existing: bool = # CODE_TRUNCATED,
        autoload_replace: bool = # CODE_TRUNCATED,
        resolve_fks: bool = # CODE_TRUNCATED,
        **dialect_kwargs: Any,
    ) -> None: # CODE_TRUNCATED
...
class Computed(FetchedValue, SchemaItem):
    ...
    def __init__(
        ...
        :param persisted:
          ...
          * ``True``, will render ``GENERATED ALWAYS AS # CODE_TRUNCATED STORED``, or the
            equivalent for the target database if supported.
          * ``False``, will render ``GENERATED ALWAYS AS # CODE_TRUNCATED VIRTUAL``, or
