...
# untyped args that make it return CompoundSelect[Unpack[tuple[Never, # CODE_TRUNCATED]]]
...
) -> CompoundSelect[_TP]: # CODE_TRUNCATED
...
@overload
def select(__ent0: _TCCA[_T0]) -> Select[Tuple[_T0]]: # CODE_TRUNCATED
...
def select(
    ...
    __ent7: _TCCA[_T7],
    __ent8: _TCCA[_T8],
) -> Select[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6, _T7, _T8]]: # CODE_TRUNCATED
...
def select(
    ...
    __ent8: _TCCA[_T8],
    __ent9: _TCCA[_T9],
) -> Select[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6, _T7, _T8, _T9]]: # CODE_TRUNCATED
