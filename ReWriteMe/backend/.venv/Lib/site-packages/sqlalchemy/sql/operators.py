...
class custom_op(OperatorType, Generic[_T]):
    ...
    def _hash_key(self) -> Union[CacheConst, Tuple[Any, # CODE_TRUNCATED]]:
        return (
            self.__class__,
            self.opstring,
            self.precedence,
...
class ColumnOperators(Operators):
    ...
    if typing.TYPE_CHECKING:
        ...
        def operate(
            self, op: OperatorType, *other: Any, **kwargs: Any
        ) -> ColumnOperators: # CODE_TRUNCATED
    ...
    if TYPE_CHECKING:
        ...
        def isnot_distinct_from(self, other: Any) -> ColumnOperators: # CODE_TRUNCATED
    ...
    if TYPE_CHECKING:
        ...
        def notin_(self, other: Any) -> ColumnOperators: # CODE_TRUNCATED
    ...
    if TYPE_CHECKING:
        ...
        def isnot(self, other: Any) -> ColumnOperators: # CODE_TRUNCATED
    ...
    if TYPE_CHECKING:
        ...
        def nullsfirst(self) -> ColumnOperators: # CODE_TRUNCATED
    ...
    if TYPE_CHECKING:
        ...
        def nullslast(self) -> ColumnOperators: # CODE_TRUNCATED
...
def _operator_fn(fn: Callable[# CODE_TRUNCATED, Any]) -> OperatorType:
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def istrue(a: Any) -> Any: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def isfalse(a: Any) -> Any: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def isnot_distinct_from(a: Any, b: Any) -> Any: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def isnot(a: Any, b: Any) -> Any: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def notlike_op(a: Any, b: Any, escape: Optional[str] = None) -> Any: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def notilike_op(a: Any, b: Any, escape: Optional[str] = None) -> Any: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def notin_op(a: Any, b: Any) -> Any: # CODE_TRUNCATED
...
def _escaped_like_impl(
    fn: Callable[# CODE_TRUNCATED, Any], other: Any, escape: Optional[str], autoescape: bool
) -> Any:
    if autoescape:
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def notmatch_op(a: Any, b: Any, **kw: Any) -> Any: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def nullsfirst_op(a: Any) -> Any: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    @_operator_fn
    def nullslast_op(a: Any) -> Any: # CODE_TRUNCATED
