...
class _EntityNamespace(Protocol):
    def __getattr__(self, key: str) -> SQLCoreOperations[Any]: # CODE_TRUNCATED
...
class _GenerativeType(compat_typing.Protocol):
    def _generate(self) -> Self: # CODE_TRUNCATED
...
class _MetaOptions(type):
    ...
    _cache_attrs: Tuple[str, # CODE_TRUNCATED]
    ...
    if TYPE_CHECKING:
        ...
        def __delattr__(self, key: str) -> None: # CODE_TRUNCATED
...
class Executable(roles.StatementRole):
    ...
    _with_context_options: Tuple[
        Tuple[Callable[[CompileState], None], Any], # CODE_TRUNCATED
    ] = ()
    ...
    def execution_options(
        ...
        *,
        ...
        synchronize_session: SynchronizeSessionArgument = # CODE_TRUNCATED,
        dml_strategy: DMLStrategyArgument = # CODE_TRUNCATED,
        render_nulls: bool = # CODE_TRUNCATED,
        is_delete_using: bool = # CODE_TRUNCATED,
        is_update_from: bool = # CODE_TRUNCATED,
...
class ColumnCollection(Generic[_COLKEY, _COL_co]):
    ...
    @overload
    def __getitem__(self, key: Union[str, int]) -> _COL_co: # CODE_TRUNCATED

    @overload
    def __getitem__(
        self, key: Tuple[Union[str, int], # CODE_TRUNCATED]
    ) -> ReadOnlyColumnCollection[_COLKEY, _COL_co]: # CODE_TRUNCATED
    ...
    def __getitem__(
        self, key: Union[str, int, slice, Tuple[Union[str, int], # CODE_TRUNCATED]]
    ...
    @overload
    def get(self, key: str, default: None = None) -> Optional[_COL_co]: # CODE_TRUNCATED

    @overload
    def get(self, key: str, default: _COL) -> Union[_COL_co, _COL]: # CODE_TRUNCATED
...
class ReadOnlyColumnCollection(
    ...
    def add(self, column: Any, key: Any = # CODE_TRUNCATED) -> Any:
        self._readonly()
