...
) -> BindParameter[_T]: # CODE_TRUNCATED
...
def literal(
    ...
    literal_execute: bool = False,
) -> BindParameter[Any]: # CODE_TRUNCATED
...
class ClauseElement(
    ...
    if typing.TYPE_CHECKING:
        ...
        def get_children(
            self, *, omit_attrs: typing_Tuple[str, # CODE_TRUNCATED] = # CODE_TRUNCATED, **kw: Any
        ) -> Iterable[ClauseElement]: # CODE_TRUNCATED
...
class SQLCoreOperations(Generic[_T_co], ColumnOperators, TypingOnly):
    ...
    if typing.TYPE_CHECKING:
        ...
        def _propagate_attrs(self) -> _PropagateAttrsType: # CODE_TRUNCATED

        def operate(
            self, op: OperatorType, *other: Any, **kwargs: Any
        ) -> ColumnElement[Any]: # CODE_TRUNCATED
        ...
        def op(
            self,
            opstring: str,
            precedence: int = # CODE_TRUNCATED,
            is_comparison: bool = # CODE_TRUNCATED,
            *,
            return_type: _TypeEngineArgument[_OPT],
            python_impl: Optional[Callable[# CODE_TRUNCATED, Any]] = None,
        ) -> Callable[[Any], BinaryExpression[_OPT]]: # CODE_TRUNCATED
        ...
        def op(
            ...
            precedence: int = # CODE_TRUNCATED,
            is_comparison: bool = # CODE_TRUNCATED,
            return_type: Optional[_TypeEngineArgument[Any]] = # CODE_TRUNCATED,
            python_impl: Optional[Callable[# CODE_TRUNCATED, Any]] = # CODE_TRUNCATED,
        ) -> Callable[[Any], BinaryExpression[Any]]: # CODE_TRUNCATED
        ...
        def bool_op(
            ...
            precedence: int = 0,
            python_impl: Optional[Callable[# CODE_TRUNCATED, Any]] = None,
        ) -> Callable[[Any], BinaryExpression[bool]]: # CODE_TRUNCATED

        def __and__(self, other: Any) -> BooleanClauseList: # CODE_TRUNCATED

        def __or__(self, other: Any) -> BooleanClauseList: # CODE_TRUNCATED

        def __invert__(self) -> ColumnElement[_T_co]: # CODE_TRUNCATED

        def __lt__(self, other: Any) -> ColumnElement[bool]: # CODE_TRUNCATED

        def __le__(self, other: Any) -> ColumnElement[bool]: # CODE_TRUNCATED
        ...
        def __hash__(self) -> int: # CODE_TRUNCATED
        ...
        def is_distinct_from(self, other: Any) -> ColumnElement[bool]: # CODE_TRUNCATED

        def is_not_distinct_from(self, other: Any) -> ColumnElement[bool]: # CODE_TRUNCATED

        def __gt__(self, other: Any) -> ColumnElement[bool]: # CODE_TRUNCATED

        def __ge__(self, other: Any) -> ColumnElement[bool]: # CODE_TRUNCATED

        def __neg__(self) -> UnaryExpression[_T_co]: # CODE_TRUNCATED

        def __contains__(self, other: Any) -> ColumnElement[bool]: # CODE_TRUNCATED

        def __getitem__(self, index: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        @overload
        def __lshift__(self: _SQO[int], other: Any) -> ColumnElement[int]: # CODE_TRUNCATED

        @overload
        def __lshift__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        def __lshift__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        @overload
        def __rshift__(self: _SQO[int], other: Any) -> ColumnElement[int]: # CODE_TRUNCATED

        @overload
        def __rshift__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        def __rshift__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        @overload
        def concat(self: _SQO[str], other: Any) -> ColumnElement[str]: # CODE_TRUNCATED

        @overload
        def concat(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        def concat(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        def like(
            self, other: Any, escape: Optional[str] = None
        ) -> BinaryExpression[bool]: # CODE_TRUNCATED

        def ilike(
            self, other: Any, escape: Optional[str] = None
        ) -> BinaryExpression[bool]: # CODE_TRUNCATED

        def bitwise_xor(self, other: Any) -> BinaryExpression[Any]: # CODE_TRUNCATED

        def bitwise_or(self, other: Any) -> BinaryExpression[Any]: # CODE_TRUNCATED

        def bitwise_and(self, other: Any) -> BinaryExpression[Any]: # CODE_TRUNCATED

        def bitwise_not(self) -> UnaryExpression[_T_co]: # CODE_TRUNCATED

        def bitwise_lshift(self, other: Any) -> BinaryExpression[Any]: # CODE_TRUNCATED

        def bitwise_rshift(self, other: Any) -> BinaryExpression[Any]: # CODE_TRUNCATED
        ...
        def is_(self, other: Any) -> BinaryExpression[bool]: # CODE_TRUNCATED

        def is_not(self, other: Any) -> BinaryExpression[bool]: # CODE_TRUNCATED

        def isnot(self, other: Any) -> BinaryExpression[bool]: # CODE_TRUNCATED
        ...
        ) -> ColumnElement[bool]: # CODE_TRUNCATED
        ...
        def contains(self, other: Any, **kw: Any) -> ColumnElement[bool]: # CODE_TRUNCATED

        def icontains(self, other: Any, **kw: Any) -> ColumnElement[bool]: # CODE_TRUNCATED

        def match(self, other: Any, **kwargs: Any) -> ColumnElement[bool]: # CODE_TRUNCATED
        ...
        ) -> ColumnElement[str]: # CODE_TRUNCATED

        def desc(self) -> UnaryExpression[_T_co]: # CODE_TRUNCATED

        def asc(self) -> UnaryExpression[_T_co]: # CODE_TRUNCATED

        def nulls_first(self) -> UnaryExpression[_T_co]: # CODE_TRUNCATED

        def nullsfirst(self) -> UnaryExpression[_T_co]: # CODE_TRUNCATED

        def nulls_last(self) -> UnaryExpression[_T_co]: # CODE_TRUNCATED

        def nullslast(self) -> UnaryExpression[_T_co]: # CODE_TRUNCATED

        def collate(self, collation: str) -> CollationClause: # CODE_TRUNCATED

        def between(
            self, cleft: Any, cright: Any, symmetric: bool = False
        ) -> BinaryExpression[bool]: # CODE_TRUNCATED

        def distinct(self: _SQO[_T_co]) -> UnaryExpression[_T_co]: # CODE_TRUNCATED

        def any_(self) -> CollectionAggregate[Any]: # CODE_TRUNCATED

        def all_(self) -> CollectionAggregate[Any]: # CODE_TRUNCATED
        ...
        def __add__(
            self: _SQO[_NMT],
            other: Any,
        ) -> ColumnElement[_NMT]: # CODE_TRUNCATED
        ...
        @overload
        def __add__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        def __add__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        @overload
        def __radd__(self: _SQO[_NMT], other: Any) -> ColumnElement[_NMT]: # CODE_TRUNCATED

        @overload
        def __radd__(self: _SQO[str], other: Any) -> ColumnElement[str]: # CODE_TRUNCATED

        def __radd__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED
        ...
        @overload
        def __sub__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED
        ...
        @overload
        def __rsub__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED
        ...
        @overload
        def __mul__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED
        ...
        @overload
        def __rmul__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        def __rmul__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        @overload
        def __mod__(self: _SQO[_NMT], other: Any) -> ColumnElement[_NMT]: # CODE_TRUNCATED

        @overload
        def __mod__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        def __mod__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED

        @overload
        def __rmod__(self: _SQO[_NMT], other: Any) -> ColumnElement[_NMT]: # CODE_TRUNCATED

        @overload
        def __rmod__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED
        ...
        ) -> ColumnElement[_NUMERIC]: # CODE_TRUNCATED

        @overload
        def __truediv__(self: _SQO[_NT], other: Any) -> ColumnElement[_NT]: # CODE_TRUNCATED

        @overload
        def __truediv__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED
        ...
        @overload
        def __rtruediv__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED
        ...
        @overload
        def __floordiv__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED
        ...
        @overload
        def __rfloordiv__(self, other: Any) -> ColumnElement[Any]: # CODE_TRUNCATED
...
class ColumnElement(
    ...
    if TYPE_CHECKING:
        ...
        def _ungroup(self) -> ColumnElement[_T]: # CODE_TRUNCATED

    @overload
    def self_group(self, against: None = None) -> ColumnElement[_T]: # CODE_TRUNCATED
    ...
    @overload
    def _negate(self: ColumnElement[bool]) -> ColumnElement[bool]: # CODE_TRUNCATED

    @overload
    def _negate(self: ColumnElement[_T]) -> ColumnElement[_T]: # CODE_TRUNCATED
        ...
        if type_ is None:
            ...
            if value:
                if expanding:
                    ...
                    check_value = value
                cast("BindParameter[typing_Tuple[Any, # CODE_TRUNCATED]]", self).type = (
...
class OperatorExpression(ColumnElement[_T]):
    ...
    def _flattened_operator_clauses(
        self,
    ) -> typing_Tuple[ColumnElement[Any], # CODE_TRUNCATED]:
        raise NotImplementedError()
...
class ExpressionClauseList(OperatorExpression[_T]):
    ...
    clauses: typing_Tuple[ColumnElement[Any], # CODE_TRUNCATED]
...
class Tuple(ClauseList, ColumnElement[typing_Tuple[Any, # CODE_TRUNCATED]]):
...
class BinaryExpression(OperatorExpression[_T]):
    ...
    if typing.TYPE_CHECKING:
        ...
        ) -> BinaryExpression[_T]: # CODE_TRUNCATED
...
class _OverrideBinds(Grouping[_T]):
    ...
    ) -> Optional[typing_Tuple[Any, # CODE_TRUNCATED]]:
...
class WithinGroup(ColumnElement[_T]):
    ...
    @overload
    def filter(self) -> Self: # CODE_TRUNCATED
    ...
    ) -> FunctionFilter[_T]: # CODE_TRUNCATED
...
class quoted_name(util.MemoizedSlots, str):
    ...
    @overload
    @classmethod
    def construct(cls, value: str, quote: Optional[bool]) -> quoted_name: # CODE_TRUNCATED

    @overload
    @classmethod
    def construct(cls, value: None, quote: Optional[bool]) -> None: # CODE_TRUNCATED
