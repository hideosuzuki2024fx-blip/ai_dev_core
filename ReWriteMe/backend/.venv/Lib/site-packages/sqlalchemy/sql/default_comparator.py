...
def _boolean_compare(
    ...
    *,
    ...
    reverse: bool = False,
    _python_is_types: Tuple[Type[Any], # CODE_TRUNCATED] = (type(None), bool),
...
operator_lookup: Dict[
    str,
    Tuple[
        Callable[# CODE_TRUNCATED, ColumnElement[Any]],
        util.immutabledict[
            str, Union[OperatorType, Callable[# CODE_TRUNCATED, ColumnElement[Any]]]
        ],
    ],
] = {
