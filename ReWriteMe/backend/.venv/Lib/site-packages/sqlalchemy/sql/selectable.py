...
class _JoinTargetProtocol(Protocol):
    ...
    def _from_objects(self) -> List[FromClause]: # CODE_TRUNCATED

    @util.ro_non_memoized_property
    def entity_namespace(self) -> _EntityNamespace: # CODE_TRUNCATED
...
class HasPrefixes:
    _prefixes: Tuple[Tuple[DQLDMLClauseElement, str], # CODE_TRUNCATED] = ()
...
class HasSuffixes:
    _suffixes: Tuple[Tuple[DQLDMLClauseElement, str], # CODE_TRUNCATED] = ()
...
class HasHints:
    ...
    _statement_hints: Tuple[Tuple[str, str], # CODE_TRUNCATED] = ()
    ...
    def with_hint(
        ...
        .. sourcecode:: sql
            ...
            select /*+ index(mytable ix_mytable) */ # CODE_TRUNCATED from mytable
...
class FromClause(roles.AnonymizedFromClauseRole, Selectable):
    ...
    * Methods to generate various derivations of a "from" clause, including
    ...
    if TYPE_CHECKING:
        ...
        ) -> Union[FromGrouping, Self]: # CODE_TRUNCATED
...
class SelectLabelStyle(Enum):
    ...
    .. sourcecode:: pycon+sql
        ...
        >>> print(
        # CODE_TRUNCATED     select(table1, table2)
        # CODE_TRUNCATED     .join(table2, true())
        # CODE_TRUNCATED     .set_label_style(LABEL_STYLE_NONE)
        # CODE_TRUNCATED )
    ...
    .. sourcecode:: pycon+sql
        ...
        # CODE_TRUNCATED     table,
        # CODE_TRUNCATED     column,
        # CODE_TRUNCATED     select,
        # CODE_TRUNCATED     true,
        # CODE_TRUNCATED     LABEL_STYLE_TABLENAME_PLUS_COL,
        # CODE_TRUNCATED )
        >>> table1 = table("table1", column("columna"), column("columnb"))
        >>> table2 = table("table2", column("columna"), column("columnc"))
        >>> print(
        # CODE_TRUNCATED     select(table1, table2)
        # CODE_TRUNCATED     .join(table2, true())
        # CODE_TRUNCATED     .set_label_style(LABEL_STYLE_TABLENAME_PLUS_COL)
        # CODE_TRUNCATED )
    ...
    .. sourcecode:: pycon+sql
        ...
        # CODE_TRUNCATED     select,
        # CODE_TRUNCATED     true,
        # CODE_TRUNCATED     LABEL_STYLE_DISAMBIGUATE_ONLY,
        # CODE_TRUNCATED )
        >>> table1 = table("table1", column("columna"), column("columnb"))
        >>> table2 = table("table2", column("columna"), column("columnc"))
        >>> print(
        # CODE_TRUNCATED     select(table1, table2)
        # CODE_TRUNCATED     .join(table2, true())
        # CODE_TRUNCATED     .set_label_style(LABEL_STYLE_DISAMBIGUATE_ONLY)
        # CODE_TRUNCATED )
...
class TableValuedAlias(LateralFromClause, Alias):
    ...
    def render_derived(
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> print(
            # CODE_TRUNCATED     select(
            # CODE_TRUNCATED         func.unnest(array(["one", "two", "three"]))
            # CODE_TRUNCATED         .table_valued("x", with_ordinality="o")
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> print(
            # CODE_TRUNCATED     select(
            # CODE_TRUNCATED         func.json_to_recordset('[{"a":1,"b":"foo"},{"a":"2","c":"bar"}]')
            # CODE_TRUNCATED         .table_valued(column("a", Integer), column("b", String))
            # CODE_TRUNCATED         .render_derived(with_types=True)
            # CODE_TRUNCATED     )
            # CODE_TRUNCATED )
...
class HasCTE(roles.HasCTERole, SelectsRows):
    ...
    _independent_ctes: Tuple[CTE, # CODE_TRUNCATED] = ()
    _independent_ctes_opts: Tuple[_CTEOpts, # CODE_TRUNCATED] = ()
...
class TableClause(roles.DMLTableRole, Immutable, NamedFromClause):
    ...
    if TYPE_CHECKING:
        ...
        def columns(
            self,
        ) -> ReadOnlyColumnCollection[str, ColumnClause[Any]]: # CODE_TRUNCATED

        @util.ro_non_memoized_property
        def c(self) -> ReadOnlyColumnCollection[str, ColumnClause[Any]]: # CODE_TRUNCATED
...
class Values(roles.InElementRole, HasCTE, Generative, LateralFromClause):
    ...
    _data: Tuple[Sequence[Tuple[Any, # CODE_TRUNCATED]], # CODE_TRUNCATED] = ()
    _column_args: Tuple[NamedColumn[Any], # CODE_TRUNCATED]
    ...
    @_generative
    def data(self, values: Sequence[Tuple[Any, # CODE_TRUNCATED]]) -> Self:
...
class ScalarValues(roles.InElementRole, GroupedElement, ColumnElement[Any]):
    ...
    def __init__(
        ...
        data: Tuple[Sequence[Tuple[Any, # CODE_TRUNCATED]], # CODE_TRUNCATED],
        literal_binds: bool,
    ):
        super().__init__()
    ...
    if TYPE_CHECKING:
        ...
        def _ungroup(self) -> ColumnElement[Any]: # CODE_TRUNCATED
...
class SelectStatementGrouping(GroupedElement, SelectBase, Generic[_SB]):
    ...
    if TYPE_CHECKING:
        ...
        def _ungroup(self) -> _SB: # CODE_TRUNCATED
...
class GenerativeSelect(DialectKWArgs, SelectBase, Generative):
    ...
    _order_by_clauses: Tuple[ColumnElement[Any], # CODE_TRUNCATED] = ()
    _group_by_clauses: Tuple[ColumnElement[Any], # CODE_TRUNCATED] = ()
...
class SelectState(util.MemoizedSlots, CompileState):
    ...
    if TYPE_CHECKING:
        ...
        ) -> Type[SelectState]: # CODE_TRUNCATED
    ...
    def _setup_joins(
        self,
        args: Tuple[_SetupJoinsElement, # CODE_TRUNCATED],
...
class _SelectFromElements:
    ...
    _where_criteria: Tuple[ColumnElement[Any], # CODE_TRUNCATED]
    _from_obj: Tuple[FromClause, # CODE_TRUNCATED]
...
class _MemoizedSelectEntities(
    ...
    _raw_columns: List[_ColumnsClauseElement]
    _setup_joins: Tuple[_SetupJoinsElement, # CODE_TRUNCATED]
    _with_options: Tuple[ExecutableOption, # CODE_TRUNCATED]
...
class Select(
    ...
    _setup_joins: Tuple[_SetupJoinsElement, # CODE_TRUNCATED] = ()
    _memoized_select_entities: Tuple[TODO_Any, # CODE_TRUNCATED] = ()

    _raw_columns: List[_ColumnsClauseElement]

    _distinct: bool = False
    _distinct_on: Tuple[ColumnElement[Any], # CODE_TRUNCATED] = ()
    _correlate: Tuple[FromClause, # CODE_TRUNCATED] = ()
    _correlate_except: Optional[Tuple[FromClause, # CODE_TRUNCATED]] = None
    _where_criteria: Tuple[ColumnElement[Any], # CODE_TRUNCATED] = ()
    _having_criteria: Tuple[ColumnElement[Any], # CODE_TRUNCATED] = ()
    _from_obj: Tuple[FromClause, # CODE_TRUNCATED] = ()
    ...
    if TYPE_CHECKING:
        ...
        ) -> ScalarSelect[Any]: # CODE_TRUNCATED

        @overload
        def scalar_subquery(
            self: Select[Tuple[_NOT_ENTITY]],
        ) -> ScalarSelect[_NOT_ENTITY]: # CODE_TRUNCATED

        @overload
        def scalar_subquery(self) -> ScalarSelect[Any]: # CODE_TRUNCATED
            ...
            [
                {
                    'name': 'id',
                    'type': Integer(),
                    'expr': Column('id', Integer(), # CODE_TRUNCATED)},
                {
                    'name': 'name',
                    'type': String(length=30),
                    'expr': Column('name', String(length=30), # CODE_TRUNCATED)}
            ]
    ...
    # START OVERLOADED FUNCTIONS self.with_only_columns Select 1-8 ", *, maintain_column_froms: bool =# CODE_TRUNCATED" # noqa: E501
    ...
    def with_only_columns(
        self, __ent0: _TCCA[_T0], *, maintain_column_froms: bool = # CODE_TRUNCATED
    ) -> Select[Tuple[_T0]]: # CODE_TRUNCATED
    ...
    def with_only_columns(
        ...
        __ent1: _TCCA[_T1],
        *,
        maintain_column_froms: bool = # CODE_TRUNCATED,
    ) -> Select[Tuple[_T0, _T1]]: # CODE_TRUNCATED
    ...
    def with_only_columns(
        ...
        *,
        maintain_column_froms: bool = # CODE_TRUNCATED,
    ) -> Select[Tuple[_T0, _T1, _T2]]: # CODE_TRUNCATED
    ...
    def with_only_columns(
        ...
        *,
        maintain_column_froms: bool = # CODE_TRUNCATED,
    ) -> Select[Tuple[_T0, _T1, _T2, _T3]]: # CODE_TRUNCATED
    ...
    def with_only_columns(
        ...
        *,
        maintain_column_froms: bool = # CODE_TRUNCATED,
    ) -> Select[Tuple[_T0, _T1, _T2, _T3, _T4]]: # CODE_TRUNCATED
    ...
    def with_only_columns(
        ...
        *,
        maintain_column_froms: bool = # CODE_TRUNCATED,
    ) -> Select[Tuple[_T0, _T1, _T2, _T3, _T4, _T5]]: # CODE_TRUNCATED
    ...
    def with_only_columns(
        ...
        *,
        maintain_column_froms: bool = # CODE_TRUNCATED,
    ) -> Select[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6]]: # CODE_TRUNCATED
    ...
    def with_only_columns(
        ...
        *,
        maintain_column_froms: bool = # CODE_TRUNCATED,
    ) -> Select[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6, _T7]]: # CODE_TRUNCATED
