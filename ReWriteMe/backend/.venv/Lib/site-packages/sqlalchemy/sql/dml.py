...
if TYPE_CHECKING:
    ...
    def isupdate(dml: DMLState) -> TypeGuard[UpdateDMLState]: # CODE_TRUNCATED

    def isdelete(dml: DMLState) -> TypeGuard[DeleteDMLState]: # CODE_TRUNCATED

    def isinsert(dml: DMLState) -> TypeGuard[InsertDMLState]: # CODE_TRUNCATED
...
class DMLState(CompileState):
    ...
    if TYPE_CHECKING:
        ...
        @classmethod
        def get_plugin_class(cls, statement: Executable) -> Type[DMLState]: # CODE_TRUNCATED
...
class UpdateBase(
    ...
    _return_defaults_columns: Optional[Tuple[_ColumnsClauseElement, # CODE_TRUNCATED]] = (
        None
    )
    _supplemental_returning: Optional[Tuple[_ColumnsClauseElement, # CODE_TRUNCATED]] = None
    _returning: Tuple[_ColumnsClauseElement, # CODE_TRUNCATED] = ()
    ...
    def returning(
        ...
        **__kw: Any,
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> stmt = (
            # CODE_TRUNCATED     table.update()
            # CODE_TRUNCATED     .where(table.c.data == "value")
            # CODE_TRUNCATED     .values(status="X")
            # CODE_TRUNCATED     .returning(table.c.server_flag, table.c.updated_timestamp)
            # CODE_TRUNCATED )
            >>> print(stmt)
        ...
        .. sourcecode:: pycon+sql
            ...
            # CODE_TRUNCATED     (table.c.first_name + " " + table.c.last_name).label("fullname")
            # CODE_TRUNCATED )
            >>> print(stmt)
    ...
    def entity_description(self) -> Dict[str, Any]:
        ...
        refers to the :class:`.Table` being inserted, updated, or deleted::
            ...
            {
                "name": "user_table",
                "table": Table("user_table", # CODE_TRUNCATED)
            }
            ...
            [
                {
                    "name": "id",
                    "type": Integer,
                    "expr": Column("id", Integer(), table=<user>, # CODE_TRUNCATED)
                },
                {
                    "name": "name",
                    "type": String(),
                    "expr": Column("name", String(), table=<user>, # CODE_TRUNCATED)
                },
            ]
...
class Insert(ValuesBase):
    ...
    def from_select(
        ...
        an ``INSERT# CODE_TRUNCATEDFROM SELECT`` statement.
    ...
    if TYPE_CHECKING:
        ...
        ) -> ReturningInsert[Tuple[_T0]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
        ) -> ReturningInsert[Tuple[_T0, _T1]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
        ) -> ReturningInsert[Tuple[_T0, _T1, _T2]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
        ) -> ReturningInsert[Tuple[_T0, _T1, _T2, _T3]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
        ) -> ReturningInsert[Tuple[_T0, _T1, _T2, _T3, _T4]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
        ) -> ReturningInsert[Tuple[_T0, _T1, _T2, _T3, _T4, _T5]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            *,
            sort_by_parameter_order: bool = False,
        ) -> ReturningInsert[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            *cols: _ColumnsClauseArgument[Any],
            sort_by_parameter_order: bool = False,
            **__kw: Any,
        ) -> ReturningInsert[Any]: # CODE_TRUNCATED
...
class DMLWhereBase:
    ...
    def where(self, *whereclause: _ColumnExpressionArgument[bool]) -> Self:
        ...
        ``UPDATE# CODE_TRUNCATEDFROM`` as well as ``DELETE..USING``.  For backends that
...
class Update(DMLWhereBase, ValuesBase):
    ...
    if TYPE_CHECKING:
        ...
        ) -> ReturningUpdate[Tuple[_T0]]: # CODE_TRUNCATED

        @overload
        def returning(
            self, __ent0: _TCCA[_T0], __ent1: _TCCA[_T1]
        ) -> ReturningUpdate[Tuple[_T0, _T1]]: # CODE_TRUNCATED

        @overload
        def returning(
            self, __ent0: _TCCA[_T0], __ent1: _TCCA[_T1], __ent2: _TCCA[_T2]
        ) -> ReturningUpdate[Tuple[_T0, _T1, _T2]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            __ent2: _TCCA[_T2],
            __ent3: _TCCA[_T3],
        ) -> ReturningUpdate[Tuple[_T0, _T1, _T2, _T3]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            __ent3: _TCCA[_T3],
            __ent4: _TCCA[_T4],
        ) -> ReturningUpdate[Tuple[_T0, _T1, _T2, _T3, _T4]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            __ent4: _TCCA[_T4],
            __ent5: _TCCA[_T5],
        ) -> ReturningUpdate[Tuple[_T0, _T1, _T2, _T3, _T4, _T5]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            __ent5: _TCCA[_T5],
            __ent6: _TCCA[_T6],
        ) -> ReturningUpdate[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6]]: # CODE_TRUNCATED
        ...
        ) -> ReturningUpdate[Any]: # CODE_TRUNCATED
...
class Delete(DMLWhereBase, UpdateBase):
    ...
    if TYPE_CHECKING:
        ...
        def returning(
            self, __ent0: _TCCA[_T0]
        ) -> ReturningDelete[Tuple[_T0]]: # CODE_TRUNCATED

        @overload
        def returning(
            self, __ent0: _TCCA[_T0], __ent1: _TCCA[_T1]
        ) -> ReturningDelete[Tuple[_T0, _T1]]: # CODE_TRUNCATED

        @overload
        def returning(
            self, __ent0: _TCCA[_T0], __ent1: _TCCA[_T1], __ent2: _TCCA[_T2]
        ) -> ReturningDelete[Tuple[_T0, _T1, _T2]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            __ent2: _TCCA[_T2],
            __ent3: _TCCA[_T3],
        ) -> ReturningDelete[Tuple[_T0, _T1, _T2, _T3]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            __ent3: _TCCA[_T3],
            __ent4: _TCCA[_T4],
        ) -> ReturningDelete[Tuple[_T0, _T1, _T2, _T3, _T4]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            __ent4: _TCCA[_T4],
            __ent5: _TCCA[_T5],
        ) -> ReturningDelete[Tuple[_T0, _T1, _T2, _T3, _T4, _T5]]: # CODE_TRUNCATED
        ...
        def returning(
            ...
            __ent5: _TCCA[_T5],
            __ent6: _TCCA[_T6],
        ) -> ReturningDelete[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6]]: # CODE_TRUNCATED
        ...
        def returning(
            self, *cols: _ColumnsClauseArgument[Any], **__kw: Any
        ) -> ReturningDelete[Any]: # CODE_TRUNCATED
