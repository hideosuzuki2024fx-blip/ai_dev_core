    ...
    **kw: Any,
    ...
    if (
        ...
        multi_extended_values = _extend_values_for_multiparams(
            ...
            cast("Callable[# CODE_TRUNCATED, str]", _column_as_key),
            kw,
        )
...
def _create_bind_param(
    ...
    value: Any,
    process: Literal[True] = # CODE_TRUNCATED,
    required: bool = False,
...
def _create_insert_prefetch_bind_param(
    ...
    **kw: Any,
) -> elements.BindParameter[Any]: # CODE_TRUNCATED
...
def _extend_values_for_multiparams(
    ...
    _column_as_key: Callable[# CODE_TRUNCATED, str],
    kw: Dict[str, Any],
