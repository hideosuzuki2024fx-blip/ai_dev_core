...
class ResultColumnsEntry(NamedTuple):
    ...
    objects: Tuple[Any, # CODE_TRUNCATED]
...
class ExpandedState(NamedTuple):
    ...
    @property
    def positional_parameters(self) -> Tuple[Any, # CODE_TRUNCATED]:
...
class _InsertManyValuesBatch(NamedTuple):
    ...
    sentinel_values: Sequence[Tuple[Any, # CODE_TRUNCATED]]
...
class SQLCompiler(Compiled):
    ...
    TextualSelect, e.g. text("# CODE_TRUNCATED.").columns(# CODE_TRUNCATED), where it is required
    ...
    def visit_column(
        ...
        result_map_targets: Tuple[Any, # CODE_TRUNCATED] = (),
    ...
    def visit_alias(
        ...
        **kwargs,
        ...
        if lateral:
            ...
            # for lateral objects, we track a second from_linter that is# CODE_TRUNCATED
    ...
    **kw)`` and returns a select object.   this is used for structural changes
    ...
    def _compose_select_body(
        ...
        # so that a no-col SELECT comes out as "SELECT WHERE# CODE_TRUNCATED" or
        # "SELECT FROM # CODE_TRUNCATED".
    ...
    def _deliver_insertmanyvalues_batches(
        ...
        if imv.is_default_expr and not self.dialect.supports_default_metavalue:
            ...
            # INSERT INTO table (pk_col) VALUES (DEFAULT), (DEFAULT), # CODE_TRUNCATED
...
class DDLCompiler(Compiled):
    ...
    if TYPE_CHECKING:
        ...
        def __init__(
            ...
            render_schema_translate: bool = # CODE_TRUNCATED,
            compile_kwargs: Mapping[str, Any] = # CODE_TRUNCATED,
        ): # CODE_TRUNCATED
...
class _SchemaForObjectCallable(Protocol):
    def __call__(self, __obj: Any) -> str: # CODE_TRUNCATED


class _BindNameForColProtocol(Protocol):
    def __call__(self, col: ColumnClause[Any]) -> str: # CODE_TRUNCATED
