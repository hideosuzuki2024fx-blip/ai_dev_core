...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    packagenames: Tuple[str, # CODE_TRUNCATED] = ()
    ...
    def table_valued(
        ...
        .. sourcecode:: pycon+sql
            ...
            # CODE_TRUNCATED     "value", "start", "stop", "step"
            # CODE_TRUNCATED )
        ...
        .. sourcecode:: pycon+sql
            ...
            # CODE_TRUNCATED     "gen", with_ordinality="ordinality"
            # CODE_TRUNCATED )
            >>> print(select(fn))
        ...
        .. seealso::
            ...
            using a derived column clause, e.g. ``AS name(col1, col2, # CODE_TRUNCATED)``
...
class _FunctionGenerator:
    ...
    .. sourcecode:: pycon+sql
        ...
        >>> print(
        # CODE_TRUNCATED     func.my_string("hi", type_=Unicode)
        # CODE_TRUNCATED     + " "
        # CODE_TRUNCATED     + func.my_string("there", type_=Unicode)
        # CODE_TRUNCATED )
    ...
    ) -> Function[_T]: # CODE_TRUNCATED

    @overload
    def __call__(self, *c: Any, **kwargs: Any) -> Function[Any]: # CODE_TRUNCATED
    ...
    if TYPE_CHECKING:
        ...
        @property
        def aggregate_strings(self) -> Type[aggregate_strings]: # CODE_TRUNCATED

        @property
        def ansifunction(self) -> Type[AnsiFunction[Any]]: # CODE_TRUNCATED
        ...
        @property
        def cast(self) -> Type[Cast[Any]]: # CODE_TRUNCATED

        @property
        def char_length(self) -> Type[char_length]: # CODE_TRUNCATED
        ...
        @property
        def concat(self) -> Type[concat]: # CODE_TRUNCATED

        @property
        def count(self) -> Type[count]: # CODE_TRUNCATED

        @property
        def cube(self) -> Type[cube[Any]]: # CODE_TRUNCATED

        @property
        def cume_dist(self) -> Type[cume_dist]: # CODE_TRUNCATED

        @property
        def current_date(self) -> Type[current_date]: # CODE_TRUNCATED

        @property
        def current_time(self) -> Type[current_time]: # CODE_TRUNCATED

        @property
        def current_timestamp(self) -> Type[current_timestamp]: # CODE_TRUNCATED

        @property
        def current_user(self) -> Type[current_user]: # CODE_TRUNCATED

        @property
        def dense_rank(self) -> Type[dense_rank]: # CODE_TRUNCATED

        @property
        def extract(self) -> Type[Extract]: # CODE_TRUNCATED

        @property
        def grouping_sets(self) -> Type[grouping_sets[Any]]: # CODE_TRUNCATED

        @property
        def localtime(self) -> Type[localtime]: # CODE_TRUNCATED

        @property
        def localtimestamp(self) -> Type[localtimestamp]: # CODE_TRUNCATED
        ...
        @property
        def mode(self) -> Type[mode[Any]]: # CODE_TRUNCATED

        @property
        def next_value(self) -> Type[next_value]: # CODE_TRUNCATED

        @property
        def now(self) -> Type[now]: # CODE_TRUNCATED

        @property
        def orderedsetagg(self) -> Type[OrderedSetAgg[Any]]: # CODE_TRUNCATED

        @property
        def percent_rank(self) -> Type[percent_rank]: # CODE_TRUNCATED

        @property
        def percentile_cont(self) -> Type[percentile_cont[Any]]: # CODE_TRUNCATED

        @property
        def percentile_disc(self) -> Type[percentile_disc[Any]]: # CODE_TRUNCATED

        @property
        def random(self) -> Type[random]: # CODE_TRUNCATED

        @property
        def rank(self) -> Type[rank]: # CODE_TRUNCATED

        @property
        def rollup(self) -> Type[rollup[Any]]: # CODE_TRUNCATED

        @property
        def session_user(self) -> Type[session_user]: # CODE_TRUNCATED
        ...
        @property
        def sysdate(self) -> Type[sysdate]: # CODE_TRUNCATED

        @property
        def user(self) -> Type[user]: # CODE_TRUNCATED
...
class Function(FunctionElement[_T]):
    ...
    def __init__(
        ...
        *clauses: _ColumnExpressionOrLiteralArgument[_T],
        type_: None = # CODE_TRUNCATED,
        packagenames: Optional[Tuple[str, # CODE_TRUNCATED]] = # CODE_TRUNCATED,
    ) -> None: # CODE_TRUNCATED
    ...
    def __init__(
        ...
        *clauses: _ColumnExpressionOrLiteralArgument[Any],
        type_: _TypeEngineArgument[_T] = # CODE_TRUNCATED,
        packagenames: Optional[Tuple[str, # CODE_TRUNCATED]] = # CODE_TRUNCATED,
    ) -> None: # CODE_TRUNCATED
    ...
    def __init__(
        ...
        *clauses: _ColumnExpressionOrLiteralArgument[Any],
        type_: Optional[_TypeEngineArgument[_T]] = None,
        packagenames: Optional[Tuple[str, # CODE_TRUNCATED]] = None,
    ) -> None:
