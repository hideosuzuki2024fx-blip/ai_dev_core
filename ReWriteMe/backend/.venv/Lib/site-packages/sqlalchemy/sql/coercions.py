...
def expect(
    ...
    element: Any,
    *,
    as_key: Literal[True] = # CODE_TRUNCATED,
    **kw: Any,
) -> str: # CODE_TRUNCATED
...
def expect(
    ...
    element: Any,
    **kw: Any,
) -> Union[Column[Any], str]: # CODE_TRUNCATED
...
def expect(
    ...
    element: Any,
    **kw: Any,
) -> Union[ColumnElement[Any], TextClause]: # CODE_TRUNCATED
...
def expect(
    ...
    **kw: Any,
) -> ColumnElement[_T]: # CODE_TRUNCATED
...
def expect(
    ...
    **kw: Any,
) -> _DMLTableElement: # CODE_TRUNCATED
...
def expect(
    ...
    element: SelectBase,
    *,
    explicit_subquery: Literal[True] = # CODE_TRUNCATED,
    **kw: Any,
) -> Subquery: # CODE_TRUNCATED
...
def expect(
    ...
    **kw: Any,
) -> _ColumnsClauseElement: # CODE_TRUNCATED
...
def expect(
    ...
    **kw: Any,
) -> _JoinTargetProtocol: # CODE_TRUNCATED
