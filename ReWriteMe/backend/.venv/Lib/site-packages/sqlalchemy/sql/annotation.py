...
class SupportsAnnotations(ExternallyTraversible):
    ...
    def _deannotate(
        self,
        values: Literal[None] = # CODE_TRUNCATED,
        clone: bool = # CODE_TRUNCATED,
    ) -> Self: # CODE_TRUNCATED

    @overload
    def _deannotate(
        self,
        values: Sequence[str] = # CODE_TRUNCATED,
        clone: bool = # CODE_TRUNCATED,
    ) -> SupportsAnnotations: # CODE_TRUNCATED
    ...
    def _annotations_cache_key(self) -> Tuple[Any, # CODE_TRUNCATED]:
        anon_map_ = anon_map()
...
class SupportsWrappingAnnotations(SupportsAnnotations):
    ...
    _constructor: Callable[# CODE_TRUNCATED, SupportsWrappingAnnotations]
...
class Annotated(SupportsAnnotations):
    ...
    def __reduce__(self) -> Tuple[Type[Annotated], Tuple[Any, # CODE_TRUNCATED]]:
