...
def composite(
    ...
    *attrs: _CompositeAttrType[Any],
    ...
    doc: Optional[str] = None,
    **__kw: Any,
) -> Composite[_CC]: # CODE_TRUNCATED


@overload
def composite(
    _class_or_attr: Callable[# CODE_TRUNCATED, _CC],
    *attrs: _CompositeAttrType[Any],
    group: Optional[str] = None,
    deferred: bool = False,
    raiseload: bool = False,
...
def aliased(
    ...
    flat: bool = False,
    adapt_on_names: bool = False,
) -> AliasedClass[_O]: # CODE_TRUNCATED
