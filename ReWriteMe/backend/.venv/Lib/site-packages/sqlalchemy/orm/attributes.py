...
class QueryableAttribute(
    ...
    _extra_criteria: Tuple[ColumnElement[bool], # CODE_TRUNCATED]
    _doc: Optional[str]
    ...
    def __init__(
        ...
        extra_criteria: Tuple[ColumnElement[bool], # CODE_TRUNCATED] = (),
    ):
        self.class_ = class_
        self.key = key
...
def create_proxied_attribute(
    descriptor: Any,
) -> Callable[# CODE_TRUNCATED, QueryableAttribute[Any]]:
...
class AttributeImpl:
    ...
    def __init__(
        ...
        compare_function: Optional[Callable[# CODE_TRUNCATED, bool]] = None,
...
class HasCollectionAdapter:
    ...
    def get_collection(
        ...
        state: InstanceState[Any],
        dict_: _InstanceDict,
        user_data: Literal[None] = # CODE_TRUNCATED,
        passive: Literal[PassiveFlag.PASSIVE_OFF] = # CODE_TRUNCATED,
    ) -> CollectionAdapter: # CODE_TRUNCATED
    ...
    def get_collection(
        ...
        state: InstanceState[Any],
        dict_: _InstanceDict,
        user_data: _AdaptedCollectionProtocol = # CODE_TRUNCATED,
        passive: PassiveFlag = # CODE_TRUNCATED,
    ) -> CollectionAdapter: # CODE_TRUNCATED
    ...
    def get_collection(
        ...
        state: InstanceState[Any],
        dict_: _InstanceDict,
        user_data: Optional[_AdaptedCollectionProtocol] = # CODE_TRUNCATED,
        passive: PassiveFlag = # CODE_TRUNCATED,
    ) -> Union[
...
if TYPE_CHECKING:
    ...
    def _is_collection_attribute_impl(
        impl: AttributeImpl,
    ) -> TypeGuard[CollectionAttributeImpl]: # CODE_TRUNCATED
