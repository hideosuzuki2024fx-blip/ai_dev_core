...
class Mapper(
    ...
    primary_key: Tuple[ColumnElement[Any], # CODE_TRUNCATED]
    ...
    def identity_key_from_primary_key(
        self,
        primary_key: Tuple[Any, # CODE_TRUNCATED],
        identity_token: Optional[Any] = None,
    ) -> _IdentityKeyType[_O]:
        """Return an identity-map key for use in storing/retrieving an
    ...
    def primary_key_from_instance(self, instance: _O) -> Tuple[Any, # CODE_TRUNCATED]:
...
class _ColumnMapping(Dict["ColumnElement[Any]", "MapperProperty[Any]"]):
    ...
    def __missing__(self, column):
        ...
        raise orm_exc.UnmappedColumnError(
            "No column %s is configured on mapper %s# CODE_TRUNCATED"
            % (column, self.mapper)
        )
