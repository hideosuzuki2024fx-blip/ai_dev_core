...
if TYPE_CHECKING:
    ...
    def manager_of_class(cls: Type[_O]) -> ClassManager[_O]: # CODE_TRUNCATED

    @overload
    def opt_manager_of_class(cls: AliasedClass[Any]) -> None: # CODE_TRUNCATED

    @overload
    def opt_manager_of_class(
        cls: _ExternalEntityType[_O],
    ) -> Optional[ClassManager[_O]]: # CODE_TRUNCATED

    def opt_manager_of_class(
        cls: _ExternalEntityType[_O],
    ) -> Optional[ClassManager[_O]]: # CODE_TRUNCATED

    def instance_state(instance: _O) -> InstanceState[_O]: # CODE_TRUNCATED

    def instance_dict(instance: object) -> Dict[str, Any]: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    def _state_mapper(state: InstanceState[_O]) -> Mapper[_O]: # CODE_TRUNCATED
...
class InspectionAttr:
    ...
    __slots__: Tuple[str, # CODE_TRUNCATED] = ()
...
class SQLORMOperations(SQLCoreOperations[_T_co], TypingOnly):
    ...
    if typing.TYPE_CHECKING:
        ...
        ) -> PropComparator[_T_co]: # CODE_TRUNCATED

        def and_(
            self, *criteria: _ColumnExpressionArgument[bool]
        ) -> PropComparator[bool]: # CODE_TRUNCATED
...
class ORMDescriptor(Generic[_T_co], TypingOnly):
    ...
    if typing.TYPE_CHECKING:
        ...
        ) -> ORMDescriptor[_T_co]: # CODE_TRUNCATED

        @overload
        def __get__(
            self, instance: Literal[None], owner: Any
        ) -> SQLCoreOperations[_T_co]: # CODE_TRUNCATED

        @overload
        def __get__(self, instance: object, owner: Any) -> _T_co: # CODE_TRUNCATED

        def __get__(
            self, instance: object, owner: Any
        ) -> Union[ORMDescriptor[_T_co], SQLCoreOperations[_T_co], _T_co]: # CODE_TRUNCATED
...
class Mapped(
    ...
    if typing.TYPE_CHECKING:
        ...
        ) -> InstrumentedAttribute[_T_co]: # CODE_TRUNCATED
        ...
        ) -> Union[InstrumentedAttribute[_T_co], _T_co]: # CODE_TRUNCATED

        @classmethod
        def _empty_constructor(cls, arg1: Any) -> Mapped[_T_co]: # CODE_TRUNCATED
...
class DynamicMapped(_MappedAnnotationBase[_T_co]):
    ...
    if TYPE_CHECKING:
        ...
        def __get__(
            self, instance: object, owner: Any
        ) -> AppenderQuery[_T_co]: # CODE_TRUNCATED

        def __get__(
            self, instance: Optional[object], owner: Any
        ) -> Union[InstrumentedAttribute[_T_co], AppenderQuery[_T_co]]: # CODE_TRUNCATED
...
class WriteOnlyMapped(_MappedAnnotationBase[_T_co]):
    ...
    if TYPE_CHECKING:
        ...
        def __get__(
            self, instance: object, owner: Any
        ) -> WriteOnlyCollection[_T_co]: # CODE_TRUNCATED
