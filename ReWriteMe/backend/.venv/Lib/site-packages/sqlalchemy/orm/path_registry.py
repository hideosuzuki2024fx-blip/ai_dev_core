...
if TYPE_CHECKING:
    ...
    def is_root(path: PathRegistry) -> TypeGuard[RootRegistry]: # CODE_TRUNCATED

    def is_entity(path: PathRegistry) -> TypeGuard[AbstractEntityRegistry]: # CODE_TRUNCATED
...
# _InternalEntityType[Any], Union[str, StrategizedProperty[Any]], # CODE_TRUNCATED]
...
_PathRepresentation = Tuple[_PathElementType, # CODE_TRUNCATED]
...
class PathRegistry(HasCacheKey):
    ...
    @overload
    def __getitem__(self, entity: _StrPathToken) -> TokenRegistry: # CODE_TRUNCATED

    @overload
    def __getitem__(self, entity: int) -> _PathElementType: # CODE_TRUNCATED

    @overload
    def __getitem__(self, entity: slice) -> _PathRepresentation: # CODE_TRUNCATED

    @overload
    def __getitem__(
        self, entity: _InternalEntityType[Any]
    ) -> AbstractEntityRegistry: # CODE_TRUNCATED

    @overload
    def __getitem__(
        self, entity: StrategizedProperty[Any]
    ) -> PropRegistry: # CODE_TRUNCATED
    ...
    @overload
    @classmethod
    def per_mapper(cls, mapper: Mapper[Any]) -> CachingEntityRegistry: # CODE_TRUNCATED

    @overload
    @classmethod
    def per_mapper(cls, mapper: AliasedInsp[Any]) -> SlotsEntityRegistry: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    def path_is_entity(
        path: PathRegistry,
    ) -> TypeGuard[AbstractEntityRegistry]: # CODE_TRUNCATED

    def path_is_property(path: PathRegistry) -> TypeGuard[PropRegistry]: # CODE_TRUNCATED
