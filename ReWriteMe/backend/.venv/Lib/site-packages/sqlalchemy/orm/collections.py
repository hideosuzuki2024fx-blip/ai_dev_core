...
class _CollectionConverterProtocol(Protocol):
    def __call__(self, collection: _COL) -> _COL: # CODE_TRUNCATED


class _AdaptedCollectionProtocol(Protocol):
    _sa_adapter: CollectionAdapter
    _sa_appender: Callable[# CODE_TRUNCATED, Any]
    _sa_remover: Callable[# CODE_TRUNCATED, Any]
    _sa_iterator: Callable[# CODE_TRUNCATED, Iterable[Any]]
...
class collection:
    ...
    arguments.  They are not written with parens::
        ...
        @collection.appender
        def append(self, append): # CODE_TRUNCATED

    The recipe decorators all require parens, even those that take no
    arguments::

        @collection.adds("entity")
        def insert(self, position, entity): # CODE_TRUNCATED


        @collection.removes_return()
        def popitem(self): # CODE_TRUNCATED
    ...
    def appender(fn):
        ...
        if not already decorated::
            ...
            @collection.appender
            def add(self, append): # CODE_TRUNCATED
    ...
    def remover(fn):
        ...
        :meth:`removes_return` if not already decorated::
            ...
            @collection.remover
            def zap(self, entity): # CODE_TRUNCATED


            # or, equivalently
            @collection.remover
            @collection.removes_return()
            def zap(self): # CODE_TRUNCATED
    ...
    def iterator(fn):
        ...
        return an iterator over all collection members::
            ...
            @collection.iterator
            def __iter__(self): # CODE_TRUNCATED
    ...
    def internally_instrumented(fn):
        ...
        decoration from wrapping your implementation::
            ...
            def extend(self, items): # CODE_TRUNCATED
    ...
    def converter(fn):
        ...
        of dictionary values, and other types will simply be iterated::
            ...
            def convert(self, other): # CODE_TRUNCATED
    ...
    def adds(arg: int) -> Callable[[_FN], _FN]:
        ...
        name::
            ...
            @collection.adds(1)
            def push(self, item): # CODE_TRUNCATED


            @collection.adds("entity")
            def do_stuff(self, thing, entity=None): # CODE_TRUNCATED
    ...
    def replaces(arg):
        ...
        Arguments can be specified positionally (i.e. integer) or by name::
            ...
            def __setitem__(self, index, item): # CODE_TRUNCATED
    ...
    def removes(arg):
        ...
        integer) or by name::
            ...
            def zap(self, item): # CODE_TRUNCATED
...
class CollectionAdapter:
    ...
    _data: Callable[# CODE_TRUNCATED, _AdaptedCollectionProtocol]
...
def _instrument_class(cls):
    ...
    # (e.g. InstrumentedList).  Catch anything else that sneaks in here# CODE_TRUNCATED
...
def _list_decorators() -> Dict[str, Callable[[_FN], _FN]]:
    ...
    # present, so no need to fire appends# CODE_TRUNCATED wrapping it with an explicit
...
__interfaces: util.immutabledict[
    ...
    Tuple[
        Dict[str, str],
        Dict[str, Callable[# CODE_TRUNCATED, Any]],
    ],
] = util.immutabledict(
    {
        list: (
