...
class _EvalNameOnly(Protocol):
    def __call__(self, name: str, module_name: str) -> Any: # CODE_TRUNCATED
...
class _ORMJoin(expression.Join):
    ...
    def __init__(
        ...
        if isinstance(onclause, attributes.QueryableAttribute):
            ...
            # used internally by joined eager loader# CODE_TRUNCATEDpossibly not ideal
            prop = onclause
