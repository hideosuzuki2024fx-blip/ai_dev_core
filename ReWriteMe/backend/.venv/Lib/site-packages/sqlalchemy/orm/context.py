...
class _DMLBulkInsertReturningColFilter(_DMLReturningColFilter):
    ...
    hierarchy among multiple DML statements# CODE_TRUNCATED.ORM bulk insert is the only
    example right now)
...
class ORMSelectCompileState(ORMCompileState, SelectState):
    ...
    def _get_current_adapter(self):
        ...
        # going forward# CODE_TRUNCATEDhowever, we unfortunately need _from_obj_alias
...
def _determine_last_joined_entity(
    setup_joins: Tuple[_SetupJoinsElement, # CODE_TRUNCATED],
