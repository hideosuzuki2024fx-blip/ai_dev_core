...
def _bulk_insert(
    ...
    *,
    ...
    render_nulls: bool,
    use_orm_insert_stmt: Literal[None] = # CODE_TRUNCATED,
    execution_options: Optional[OrmExecuteOptionsParameter] = # CODE_TRUNCATED,
) -> None: # CODE_TRUNCATED
...
def _bulk_insert(
    ...
    *,
    ...
    return_defaults: bool,
    render_nulls: bool,
    use_orm_insert_stmt: Optional[dml.Insert] = # CODE_TRUNCATED,
    execution_options: Optional[OrmExecuteOptionsParameter] = # CODE_TRUNCATED,
) -> cursor.CursorResult[Any]: # CODE_TRUNCATED
...
def _bulk_update(
    ...
    *,
    ...
    use_orm_update_stmt: Literal[None] = # CODE_TRUNCATED,
...
def _bulk_update(
    ...
    *,
    isstates: bool,
    update_changed_only: bool,
    use_orm_update_stmt: Optional[dml.Update] = # CODE_TRUNCATED,
    enable_check_rowcount: bool = True,
) -> _result.Result[Any]: # CODE_TRUNCATED
        ...
        if orm_level_statement._returning:
            ...
            if use_supplemental_cols:
                dml_level_statement = dml_level_statement.return_defaults(
                    ...
                    # whole thing# CODE_TRUNCATED).   We dont want to clutter the
...
class BulkORMDelete(BulkUDCompileState, DeleteDMLState):
    ...
    def can_use_returning(
        ...
        *,
        ...
        # DELETE# CODE_TRUNCATEDRETURNING but not DELETE# CODE_TRUNCATEDUSING# CODE_TRUNCATEDRETURNING.
        if is_delete_using:
