...
_TableArgsType = Union[Tuple[Any, # CODE_TRUNCATED], Dict[str, Any]]
...
class MappedClassProtocol(Protocol[_O]):
    ...
    def __call__(self, **kw: Any) -> _O: # CODE_TRUNCATED
...
class _DeclMappedClassProtocol(MappedClassProtocol[_O], Protocol):
    ...
    def __declare_first__(self) -> None: # CODE_TRUNCATED

    def __declare_last__(self) -> None: # CODE_TRUNCATED
...
class _DataclassArguments(TypedDict):
    ...
    dataclass_callable: Union[_NoArg, Callable[# CODE_TRUNCATED, Type[Any]]]
...
class _MapperConfig:
    ...
    def map(self, mapper_kw: _MapperKwArgs = # CODE_TRUNCATED) -> Mapper[Any]:
    ...
    def _collect_annotation(
        ...
        if attr_value is None and not is_literal(extracted_mapped_annotation):
            for elem in get_args(extracted_mapped_annotation):
                ...
                # look in Annotated[# CODE_TRUNCATED] for an ORM construct,
