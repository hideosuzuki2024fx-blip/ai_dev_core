...
_IdentityKeyType = Tuple[Type[_T], Tuple[Any, # CODE_TRUNCATED], Optional[Any]]
...
class _ORMAdapterProto(Protocol):
    ...
    def __call__(self, obj: _CE, key: Optional[str] = None) -> _CE: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    ...
    def insp_is_mapper_property(
        obj: Any,
    ) -> TypeGuard[MapperProperty[Any]]: # CODE_TRUNCATED

    def insp_is_mapper(obj: Any) -> TypeGuard[Mapper[Any]]: # CODE_TRUNCATED

    def insp_is_aliased_class(obj: Any) -> TypeGuard[AliasedInsp[Any]]: # CODE_TRUNCATED

    def insp_is_attribute(
        obj: InspectionAttr,
    ) -> TypeGuard[QueryableAttribute[Any]]: # CODE_TRUNCATED
    ...
    ) -> TypeGuard[RelationshipProperty[Any]]: # CODE_TRUNCATED
    ...
    def is_has_collection_adapter(
        impl: AttributeImpl,
    ) -> TypeGuard[HasCollectionAdapter]: # CODE_TRUNCATED
