...
class _StateChange:
    ...
    _current_fn: Optional[Callable[# CODE_TRUNCATED, Any]] = None
    ...
    def declare_states(
        ...
        prerequisite_states: Union[
            Literal[_StateChangeStates.ANY], Tuple[_StateChangeState, # CODE_TRUNCATED]
        ],
        ...
        prerequisite_state_collection = cast(
            "Tuple[_StateChangeState, # CODE_TRUNCATED]", prerequisite_states
        )
