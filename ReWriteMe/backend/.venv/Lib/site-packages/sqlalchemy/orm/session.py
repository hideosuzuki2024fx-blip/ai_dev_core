...
_PKIdentityArgument = Union[Any, Tuple[Any, # CODE_TRUNCATED]]
...
class SessionTransaction(_StateChange, TransactionalContext):
    ...
    def _iterate_self_and_parents(
        ...
        current = self
        result: Tuple[SessionTransaction, # CODE_TRUNCATED] = ()
        while current:
            result += (current,)
...
class Session(_SessionClassMethods, EventTarget):
    ...
    def _execute_internal(
        ...
        *,
        ...
        _scalar_result: Literal[True] = # CODE_TRUNCATED,
    ) -> Any: # CODE_TRUNCATED
    ...
    def _execute_internal(
        ...
        *,
        ...
        _parent_execute_state: Optional[Any] = None,
        _add_event: Optional[Any] = None,
        _scalar_result: bool = # CODE_TRUNCATED,
    ...
    @overload
    def query(self, _entity: _EntityType[_O]) -> Query[_O]: # CODE_TRUNCATED
    ...
    def _identity_lookup(
        self,
        mapper: Mapper[_O],
        primary_key_identity: Union[Any, Tuple[Any, # CODE_TRUNCATED]],
    ...
    def _get_impl(
        ...
        db_load_fn: Callable[# CODE_TRUNCATED, _O],
        *,
...
class sessionmaker(_SessionClassMethods, Generic[_S]):
    ...
    bound to a specific :class:`_engine.Connection` procured from that engine::
        ...
        with engine.connect() as connection:
            with Session(bind=connection) as session:
                # CODE_TRUNCATED  # work with session
    ...
    :class:`.sessionmaker` factory before it is first used::
        ...
        # # CODE_TRUNCATED later, when an engine URL is read from a configuration
    ...
    def __init__(
        self,
        bind: Optional[_SessionBind] = # CODE_TRUNCATED,
        *,
        class_: Type[_S],
