...
class Query(
    ...
    ) -> ScalarSelect[_MAYBE_ENTITY]: # CODE_TRUNCATED
    ...
    @overload
    def as_scalar(self) -> ScalarSelect[Any]: # CODE_TRUNCATED
    ...
    ) -> RowReturningQuery[Tuple[_O]]: # CODE_TRUNCATED

    @overload
    def only_return_tuples(
        self: Query[_O], value: Literal[False]
    ) -> Query[_O]: # CODE_TRUNCATED
    ...
    def _get_impl(
        ...
        db_load_fn: Callable[# CODE_TRUNCATED, Any],
        identity_token: Optional[Any] = None,
    ) -> Optional[Any]:
    ...
    @overload
    def with_entities(self, _entity: _EntityType[_O]) -> Query[_O]: # CODE_TRUNCATED

    @overload
    def with_entities(
        self,
        _colexpr: roles.TypedColumnsClauseRole[_T],
    ) -> RowReturningQuery[Tuple[_T]]: # CODE_TRUNCATED
    ...
    ) -> RowReturningQuery[Tuple[_T0, _T1]]: # CODE_TRUNCATED

    @overload
    def with_entities(
        self, __ent0: _TCCA[_T0], __ent1: _TCCA[_T1], __ent2: _TCCA[_T2]
    ) -> RowReturningQuery[Tuple[_T0, _T1, _T2]]: # CODE_TRUNCATED
    ...
    def with_entities(
        ...
        __ent2: _TCCA[_T2],
        __ent3: _TCCA[_T3],
    ) -> RowReturningQuery[Tuple[_T0, _T1, _T2, _T3]]: # CODE_TRUNCATED
    ...
    def with_entities(
        ...
        __ent3: _TCCA[_T3],
        __ent4: _TCCA[_T4],
    ) -> RowReturningQuery[Tuple[_T0, _T1, _T2, _T3, _T4]]: # CODE_TRUNCATED
    ...
    def with_entities(
        ...
        __ent4: _TCCA[_T4],
        __ent5: _TCCA[_T5],
    ) -> RowReturningQuery[Tuple[_T0, _T1, _T2, _T3, _T4, _T5]]: # CODE_TRUNCATED
    ...
    def with_entities(
        ...
        __ent5: _TCCA[_T5],
        __ent6: _TCCA[_T6],
    ) -> RowReturningQuery[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6]]: # CODE_TRUNCATED
    ...
    def with_entities(
        ...
        __ent6: _TCCA[_T6],
        __ent7: _TCCA[_T7],
    ) -> RowReturningQuery[Tuple[_T0, _T1, _T2, _T3, _T4, _T5, _T6, _T7]]: # CODE_TRUNCATED
    ...
    @overload
    def execution_options(self, **opt: Any) -> Self: # CODE_TRUNCATED
    ...
    def exists(self) -> Exists:
        ...
        of the form EXISTS (SELECT 1 FROM # CODE_TRUNCATED WHERE # CODE_TRUNCATED).
    ...
    def count(self) -> int:
        ...
        .. sourcecode:: sql
            ...
            SELECT count(1) AS count_1 FROM (
                SELECT <rest of query follows# CODE_TRUNCATED>
            ) AS anon_1
