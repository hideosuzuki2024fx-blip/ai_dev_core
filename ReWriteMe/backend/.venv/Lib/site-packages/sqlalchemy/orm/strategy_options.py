...
_AttrGroupType = Tuple[_AttrType, # CODE_TRUNCATED]
...
class _AbstractLoad(traversals.GenerativeOnTraversal, LoaderOption):
    ...
    @overload
    def _coerce_strat(self, strategy: _StrategySpec) -> _StrategyKey: # CODE_TRUNCATED

    @overload
    def _coerce_strat(self, strategy: Literal[None]) -> None: # CODE_TRUNCATED
    ...
    def _set_column_strategy(
        self,
        attrs: Tuple[_AttrType, # CODE_TRUNCATED],
        strategy: Optional[_StrategySpec],
        opts: Optional[_OptsType] = None,
        extra_criteria: Optional[Tuple[Any, # CODE_TRUNCATED]] = None,
    ) -> Self:
        strategy_key = self._coerce_strat(strategy)
    ...
    def _clone_for_bind_strategy(
        self,
        attrs: Optional[Tuple[_AttrType, # CODE_TRUNCATED]],
...
class Load(_AbstractLoad):
    ...
    path: PathRegistry
    context: Tuple[_LoadElement, # CODE_TRUNCATED]
    additional_source_entities: Tuple[_InternalEntityType[Any], # CODE_TRUNCATED]
...
class _WildcardLoad(_AbstractLoad):
    ...
    strategy: Optional[Tuple[Any, # CODE_TRUNCATED]]
...
class _LoadElement(
    ...
    _extra_criteria: Tuple[Any, # CODE_TRUNCATED]
...
def _generate_from_keys(
    meth: Callable[# CODE_TRUNCATED, _AbstractLoad],
    keys: Tuple[_AttrType, # CODE_TRUNCATED],
    chained: bool,
    kw: Any,
) -> _AbstractLoad:
...
def _expand_column_strategy_attrs(
    attrs: Tuple[_AttrType, # CODE_TRUNCATED],
) -> Tuple[_AttrType, # CODE_TRUNCATED]:
    return cast(
        "Tuple[_AttrType, # CODE_TRUNCATED]",
        tuple(
            a
        ...
        raise sa_exc.ArgumentError(
            ...
            % (
                ...
                (
                    ...
                    f'[{parent_entity_str}]), # CODE_TRUNCATED)" ?'
