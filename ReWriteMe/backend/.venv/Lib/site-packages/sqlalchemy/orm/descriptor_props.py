...
_composite_getters: weakref.WeakKeyDictionary[
    Type[Any], Callable[[Any], Tuple[Any, # CODE_TRUNCATED]]
...
class CompositeProperty(
    ...
    composite_class: Union[Type[_CC], Callable[# CODE_TRUNCATED, _CC]]
    attrs: Tuple[_CompositeAttrType[Any], # CODE_TRUNCATED]

    _generated_composite_accessor: CallableReference[
        Optional[Callable[[_CC], Tuple[Any, # CODE_TRUNCATED]]]
    ]
    ...
    def __init__(
        ...
        _class_or_attr: Union[
            None, Type[_CC], Callable[# CODE_TRUNCATED, _CC], _CompositeAttrType[Any]
        ] = None,
    ...
    def _composite_values_from_instance(self, value: _CC) -> Tuple[Any, # CODE_TRUNCATED]:
