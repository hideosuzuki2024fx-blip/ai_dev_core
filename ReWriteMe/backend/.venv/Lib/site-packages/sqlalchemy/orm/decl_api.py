...
_DeclaredAttrDecorated = Callable[
    # CODE_TRUNCATED, Union[Mapped[_T], ORMDescriptor[_T], SQLCoreOperations[_T]]
]
...
def synonym_for(
...
) -> Callable[[Callable[# CODE_TRUNCATED, Any]], Synonym[Any]]:
    ...
    def decorate(fn: Callable[# CODE_TRUNCATED, Any]) -> Synonym[Any]:
...
class _declared_attr_common:
    def __init__(
        self,
        fn: Callable[# CODE_TRUNCATED, Any],
...
class _declared_directive(_declared_attr_common, Generic[_T]):
    ...
    if typing.TYPE_CHECKING:
        ...
        def __init__(
            self,
            fn: Callable[# CODE_TRUNCATED, _T],
            cascading: bool = False,
        ): # CODE_TRUNCATED

        def __get__(self, instance: Optional[object], owner: Any) -> _T: # CODE_TRUNCATED

        def __set__(self, instance: Any, value: Any) -> None: # CODE_TRUNCATED

        def __delete__(self, instance: Any) -> None: # CODE_TRUNCATED

        def __call__(self, fn: Callable[# CODE_TRUNCATED, _TT]) -> _declared_directive[_TT]:
            # extensive fooling of mypy underway# CODE_TRUNCATED
            # CODE_TRUNCATED
...
class declared_attr(interfaces._MappedAttribute[_T], _declared_attr_common):
    ...
    if typing.TYPE_CHECKING:
        ...
        ) -> InstrumentedAttribute[_T]: # CODE_TRUNCATED

        @overload
        def __get__(self, instance: object, owner: Any) -> _T: # CODE_TRUNCATED

        def __get__(
            self, instance: Optional[object], owner: Any
        ) -> Union[InstrumentedAttribute[_T], _T]: # CODE_TRUNCATED
...
class MappedAsDataclass(metaclass=DCTransformDeclarative):
    ...
    def __init_subclass__(
        ...
        dataclass_callable: Union[
            _NoArg, Callable[# CODE_TRUNCATED, Type[Any]]
        ] = _NoArg.NO_ARG,
        **kw: Any,
    ) -> None:
...
class DeclarativeBase(
    ...
    **never accessed by a mapped class without being called explicitly via
    ...
    if typing.TYPE_CHECKING:
        ...
        def _sa_inspect_type(self) -> Mapper[Self]: # CODE_TRUNCATED

        def _sa_inspect_instance(self) -> InstanceState[Self]: # CODE_TRUNCATED
        ...
        def __init__(self, **kw: Any): # CODE_TRUNCATED
...
def declarative_base(
    *,
    ...
    mapper: Optional[Callable[# CODE_TRUNCATED, Mapper[Any]]] = None,
    cls: Type[Any] = object,
    name: str = "Base",
    class_registry: Optional[clsregistry._ClsRegistryType] = None,
    type_annotation_map: Optional[_TypeAnnotationMapType] = None,
    constructor: Callable[# CODE_TRUNCATED, None] = _declarative_constructor,
...
class registry:
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
    ...
    metadata: MetaData
    constructor: CallableReference[Callable[# CODE_TRUNCATED, None]]
    ...
    def _resolve_type(
        ...
        for pt, flattened in search:
            # we search through full __mro__ for types.  however# CODE_TRUNCATED
            ...
            if sql_type is not None:
                ...
                # # CODE_TRUNCATED this additional step will reject most
    ...
    @overload
    def mapped_as_dataclass(self, __cls: Type[_O]) -> Type[_O]: # CODE_TRUNCATED

    @overload
    def mapped_as_dataclass(
        self,
        __cls: Literal[None] = # CODE_TRUNCATED,
        *,
        init: Union[_NoArg, bool] = # CODE_TRUNCATED,
        repr: Union[_NoArg, bool] = # CODE_TRUNCATED,  # noqa: A002
        eq: Union[_NoArg, bool] = # CODE_TRUNCATED,
        order: Union[_NoArg, bool] = # CODE_TRUNCATED,
        unsafe_hash: Union[_NoArg, bool] = # CODE_TRUNCATED,
        match_args: Union[_NoArg, bool] = # CODE_TRUNCATED,
        kw_only: Union[_NoArg, bool] = # CODE_TRUNCATED,
        dataclass_callable: Union[_NoArg, Callable[# CODE_TRUNCATED, Type[Any]]] = # CODE_TRUNCATED,
    ) -> Callable[[Type[_O]], Type[_O]]: # CODE_TRUNCATED
    ...
    def as_declarative_base(self, **kw: Any) -> Callable[[Type[_T]], Type[_T]]:
        ...
        E.g.::
            ...
            class MyMappedClass(Base): # CODE_TRUNCATED
