...
_LegacySignatureType = Tuple[str, List[str], Callable[# CODE_TRUNCATED, Any]]


def _legacy_signature(
    since: str,
    argnames: List[str],
    converter: Optional[Callable[# CODE_TRUNCATED, Any]] = None,
) -> Callable[[_F], _F]:
...
def _standard_listen_example(
    ...
    text = (
        ...
        "\n    # # CODE_TRUNCATED (event handling logic) # CODE_TRUNCATED\n"
    )
