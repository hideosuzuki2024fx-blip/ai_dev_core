...
class _Dispatch(_DispatchCommon[_ET]):
    ...
    def __reduce__(self) -> Union[str, Tuple[Any, # CODE_TRUNCATED]]:
...
class _HasEventsDispatch(Generic[_ET]):
    ...
    if typing.TYPE_CHECKING:
        ...
        def __getattr__(self, name: str) -> _InstanceLevelDispatch[_ET]: # CODE_TRUNCATED
    ...
    def _create_dispatcher_class(
        cls, classname: str, bases: Tuple[type, # CODE_TRUNCATED], dict_: Mapping[str, Any]
    ) -> None:
...
class dispatcher(Generic[_ET]):
    ...
    ) -> Type[_Dispatch[_ET]]: # CODE_TRUNCATED

    @overload
    def __get__(self, obj: Any, cls: Type[Any]) -> _DispatchCommon[_ET]: # CODE_TRUNCATED
