...
def listen(
    target: Any, identifier: str, fn: Callable[# CODE_TRUNCATED, Any], *args: Any, **kw: Any
) -> None:
...
def listens_for(
...
) -> Callable[[Callable[# CODE_TRUNCATED, Any]], Callable[# CODE_TRUNCATED, Any]]:
    ...
    def decorate(fn: Callable[# CODE_TRUNCATED, Any]) -> Callable[# CODE_TRUNCATED, Any]:
...
def remove(target: Any, identifier: str, fn: Callable[# CODE_TRUNCATED, Any]) -> None:
    ...
    e.g.::
        ...
        # if a function was registered like this# CODE_TRUNCATED
        @event.listens_for(SomeMappedClass, "before_insert", propagate=True)
        def my_listener_function(*arg):
            pass


        # # CODE_TRUNCATED it's removed like this
...
def contains(target: Any, identifier: str, fn: Callable[# CODE_TRUNCATED, Any]) -> bool:
