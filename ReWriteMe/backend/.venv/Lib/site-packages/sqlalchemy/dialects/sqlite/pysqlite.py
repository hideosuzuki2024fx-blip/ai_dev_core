...
DATETIME or TIME types# CODE_TRUNCATEDconfused yet ?) will not perform any bind parameter
...
if TYPE_CHECKING:
    ...
    from # CODE_TRUNCATEDengine.interfaces import VersionInfoType
...
class _SQLiteDialect_pysqlite_numeric(SQLiteDialect_pysqlite):
    ...
    def _fix_sqlite_issue_99953(self) -> Any:
        ...
        def _numeric_param_as_dict(
            parameters: Any,
        ) -> Union[dict[str, Any], tuple[Any, # CODE_TRUNCATED]]:
            if parameters:
