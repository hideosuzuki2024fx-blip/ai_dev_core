...
.. sourcecode:: pycon+sql
    ...
    >>> print(
    # CODE_TRUNCATED     CreateSequence(Sequence("my_seq", start=1)).compile(
    # CODE_TRUNCATED         dialect=mssql.dialect()
    # CODE_TRUNCATED     )
    # CODE_TRUNCATED )
...
To generate a clustered primary key use::
    ...
    Table(
        "my_table",
        metadata,
        Column("x", # CODE_TRUNCATED),
        Column("y", # CODE_TRUNCATED),
...
from # CODE_TRUNCATED import Identity
from # CODE_TRUNCATED import schema as sa_schema
from # CODE_TRUNCATED import Sequence
...
from # CODE_TRUNCATEDsql import func
from # CODE_TRUNCATEDsql import quoted_name
from # CODE_TRUNCATEDsql import roles
from # CODE_TRUNCATEDsql import sqltypes
from # CODE_TRUNCATEDsql import try_cast as try_cast  # noqa: F401
from # CODE_TRUNCATEDsql import util as sql_util
from # CODE_TRUNCATEDsql._typing import is_sql_compiler
from # CODE_TRUNCATEDsql.compiler import InsertmanyvaluesSentinelOpts
from # CODE_TRUNCATEDsql.elements import TryCast as TryCast  # noqa: F401
...
from # CODE_TRUNCATEDtypes import DATETIME
from # CODE_TRUNCATEDtypes import DECIMAL
from # CODE_TRUNCATEDtypes import FLOAT
from # CODE_TRUNCATEDtypes import INTEGER
from # CODE_TRUNCATEDtypes import NCHAR
from # CODE_TRUNCATEDtypes import NUMERIC
from # CODE_TRUNCATEDtypes import NVARCHAR
from # CODE_TRUNCATEDtypes import SMALLINT
from # CODE_TRUNCATEDtypes import TEXT
from # CODE_TRUNCATEDtypes import VARCHAR
from # CODE_TRUNCATEDutil import update_wrapper
from # CODE_TRUNCATEDutil.typing import Literal

if TYPE_CHECKING:
    from # CODE_TRUNCATEDsql.dml import DMLState
    from # CODE_TRUNCATEDsql.selectable import TableClause
...
class UNIQUEIDENTIFIER(sqltypes.Uuid[sqltypes._UUID_RETURN]):
    ...
    @overload
    def __init__(
        self: UNIQUEIDENTIFIER[_python_UUID], as_uuid: Literal[True] = # CODE_TRUNCATED
    ): # CODE_TRUNCATED

    @overload
    def __init__(
        self: UNIQUEIDENTIFIER[str], as_uuid: Literal[False] = # CODE_TRUNCATED
    ): # CODE_TRUNCATED
