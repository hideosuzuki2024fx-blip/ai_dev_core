...
r""".. dialect:: oracle+oracledb
    ...
    :dbapi: oracledb
    :connectstring: oracle+oracledb://user:pass@hostname:port[/dbname][?service_name=<service>[&key=value&key=value# CODE_TRUNCATED]]
...
* calling :func:`_sa.create_engine` with ``oracle+oracledb://# CODE_TRUNCATED`` will
...
* calling :func:`_asyncio.create_async_engine` with ``oracle+oracledb://# CODE_TRUNCATED``
...
example::
    ...
    engine = sa.create_engine(
        "oracle+oracledb://# CODE_TRUNCATED",
        thick_mode={
...
from # CODE_TRUNCATEDconnectors.asyncio import AsyncAdaptFallback_dbapi_connection
from # CODE_TRUNCATEDengine import default
from # CODE_TRUNCATEDutil import asbool
from # CODE_TRUNCATEDutil import await_fallback
from # CODE_TRUNCATEDutil import await_only
