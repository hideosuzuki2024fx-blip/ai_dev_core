...
Whereas Oracle normalizes them to UPPERCASE::
    ...
    # CODE_TRUNCATED     "SELECT 1 AS SomeName FROM DUAL"
    # CODE_TRUNCATED )
    >>> result.cursor.description
...
*
  ``TABLESPACE``::
     ...
     Table("mytable", metadata, # CODE_TRUNCATED, oracle_tablespace="EXAMPLE_TABLESPACE")
...
from # CODE_TRUNCATED import Computed
...
from # CODE_TRUNCATEDsql import and_
...
from # CODE_TRUNCATEDsql import null
from # CODE_TRUNCATEDsql import or_
from # CODE_TRUNCATEDsql import select
from # CODE_TRUNCATEDsql import selectable as sa_selectable
...
from # CODE_TRUNCATEDtypes import CLOB
