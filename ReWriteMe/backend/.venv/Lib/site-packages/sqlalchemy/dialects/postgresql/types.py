...
class PGUuid(sqltypes.UUID[sqltypes._UUID_RETURN]):
    ...
    if TYPE_CHECKING:
        ...
        @overload
        def __init__(
            self: PGUuid[_python_UUID], as_uuid: Literal[True] = # CODE_TRUNCATED
        ) -> None: # CODE_TRUNCATED

        @overload
        def __init__(
            self: PGUuid[str], as_uuid: Literal[False] = # CODE_TRUNCATED
        ) -> None: # CODE_TRUNCATED

        def __init__(self, as_uuid: bool = True) -> None: # CODE_TRUNCATED
