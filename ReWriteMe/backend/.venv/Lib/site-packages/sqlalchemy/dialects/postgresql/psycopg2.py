...
.. dialect:: postgresql+psycopg2
    :name: psycopg2
    :dbapi: psycopg2
    :connectstring: postgresql+psycopg2://user:password@host:port/dbname[?key=value&key=value# CODE_TRUNCATED]
...
prefixed with ``PG_# CODE_TRUNCATED``, which are  consumed by ``libpq`` to take the place of
...
.. seealso::
    ...
    PostgreSQL documentation on how to use ``PG_# CODE_TRUNCATED``
...
from # CODE_TRUNCATEDutil import FastIntFlag
from # CODE_TRUNCATEDutil import parse_user_argument_for_enum
