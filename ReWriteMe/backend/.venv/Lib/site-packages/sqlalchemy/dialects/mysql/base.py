...
present in the pool for a fixed number of seconds::
    ...
    engine = create_engine("mysql+mysqldb://# CODE_TRUNCATED", pool_recycle=3600)
...
foreign key::
  ...
  >>> t = Table(
  # CODE_TRUNCATED     "mytable", metadata, Column("mytable_id", Integer, primary_key=True)
  # CODE_TRUNCATED )
  >>> t.create()
...
* SELECT pragma, use :meth:`_expression.Select.prefix_with` and
  :meth:`_query.Query.prefix_with`::
    ...
    select(# CODE_TRUNCATED).prefix_with(["HIGH_PRIORITY", "SQL_SMALL_RESULT"])

* UPDATE with LIMIT::

    update(# CODE_TRUNCATED).with_dialect_options(mysql_limit=10, mariadb_limit=10)

* DELETE
  with LIMIT::

    delete(# CODE_TRUNCATED).with_dialect_options(mysql_limit=10, mariadb_limit=10)
...
* optimizer hints, use :meth:`_expression.Select.prefix_with` and
  :meth:`_query.Query.prefix_with`::
    ...
    select(# CODE_TRUNCATED).prefix_with("/*+ NO_RANGE_OPTIMIZATION(t4 PRIMARY) */")

* index hints, use :meth:`_expression.Select.with_hint` and
  :meth:`_query.Query.with_hint`::

    select(# CODE_TRUNCATED).with_hint(some_table, "USE INDEX xyz")
...
* MATCH
  operator support::
        ...
        select(# CODE_TRUNCATED).where(match(col1, col2, against="some expr").in_boolean_mode())

  .. seealso::

    :class:`_mysql.match`

INSERT/DELETE# CODE_TRUNCATEDRETURNING
-------------------------
...
INSERT# CODE_TRUNCATEDON DUPLICATE KEY UPDATE (Upsert)
------------------------------------------
...
.. sourcecode:: pycon+sql
    ...
    # CODE_TRUNCATED     data=insert_stmt.inserted.data, status="U"
    # CODE_TRUNCATED )
...
.. sourcecode:: pycon+sql
    ...
    >>> on_duplicate_key_stmt = insert_stmt.on_duplicate_key_update(
    # CODE_TRUNCATED     data="some data",
    # CODE_TRUNCATED     updated_at=func.current_timestamp(),
    # CODE_TRUNCATED )
...
.. sourcecode:: pycon+sql
    ...
    >>> on_duplicate_key_stmt = insert_stmt.on_duplicate_key_update(
    # CODE_TRUNCATED     {"data": "some data", "updated_at": func.current_timestamp()},
    # CODE_TRUNCATED )
...
.. sourcecode:: pycon+sql
    ...
    # CODE_TRUNCATED     data="updated value", author=stmt.inserted.author
    # CODE_TRUNCATED )
...
full table reflection using ``Table(# CODE_TRUNCATED, autoload_with=engine)``,
...
from # CODE_TRUNCATED import literal_column
from # CODE_TRUNCATED import schema as sa_schema
from # CODE_TRUNCATED import sql
from # CODE_TRUNCATED import util
from # CODE_TRUNCATEDengine import cursor as _cursor
...
from # CODE_TRUNCATEDsql import functions
from # CODE_TRUNCATEDsql import operators
from # CODE_TRUNCATEDsql import roles
from # CODE_TRUNCATEDsql import sqltypes
from # CODE_TRUNCATEDsql import util as sql_util
from # CODE_TRUNCATEDsql import visitors
from # CODE_TRUNCATEDsql.compiler import InsertmanyvaluesSentinelOpts
from # CODE_TRUNCATEDsql.compiler import SQLCompiler
from # CODE_TRUNCATEDsql.schema import SchemaConst
from # CODE_TRUNCATEDtypes import BINARY
from # CODE_TRUNCATEDtypes import BLOB
from # CODE_TRUNCATEDtypes import BOOLEAN
from # CODE_TRUNCATEDtypes import DATE
from # CODE_TRUNCATEDtypes import LargeBinary
from # CODE_TRUNCATEDtypes import UUID
from # CODE_TRUNCATEDtypes import VARBINARY
from # CODE_TRUNCATEDutil import topological

if TYPE_CHECKING:

    from # CODE_TRUNCATEDdialects.mysql import expression
    from # CODE_TRUNCATEDdialects.mysql.dml import OnDuplicateClause
    from # CODE_TRUNCATEDengine.base import Connection
    from # CODE_TRUNCATEDengine.cursor import CursorResult
    from # CODE_TRUNCATEDengine.interfaces import DBAPIConnection
    from # CODE_TRUNCATEDengine.interfaces import DBAPICursor
    from # CODE_TRUNCATEDengine.interfaces import DBAPIModule
    from # CODE_TRUNCATEDengine.interfaces import IsolationLevel
    from # CODE_TRUNCATEDengine.interfaces import PoolProxiedConnection
    from # CODE_TRUNCATEDengine.interfaces import ReflectedCheckConstraint
    from # CODE_TRUNCATEDengine.interfaces import ReflectedColumn
    from # CODE_TRUNCATEDengine.interfaces import ReflectedForeignKeyConstraint
    from # CODE_TRUNCATEDengine.interfaces import ReflectedIndex
    from # CODE_TRUNCATEDengine.interfaces import ReflectedPrimaryKeyConstraint
    from # CODE_TRUNCATEDengine.interfaces import ReflectedTableComment
    from # CODE_TRUNCATEDengine.interfaces import ReflectedUniqueConstraint
    from # CODE_TRUNCATEDengine.row import Row
    from # CODE_TRUNCATEDengine.url import URL
    from # CODE_TRUNCATEDschema import Table
    from # CODE_TRUNCATEDsql import ddl
    from # CODE_TRUNCATEDsql import selectable
    from # CODE_TRUNCATEDsql.dml import _DMLTableElement
    from # CODE_TRUNCATEDsql.dml import Delete
    from # CODE_TRUNCATEDsql.dml import Update
    from # CODE_TRUNCATEDsql.dml import ValuesBase
    from # CODE_TRUNCATEDsql.functions import aggregate_strings
    from # CODE_TRUNCATEDsql.functions import random
    from # CODE_TRUNCATEDsql.functions import rollup
    from # CODE_TRUNCATEDsql.functions import sysdate
    from # CODE_TRUNCATEDsql.schema import Sequence as Sequence_SchemaItem
    from # CODE_TRUNCATEDsql.type_api import TypeEngine
    from # CODE_TRUNCATEDsql.visitors import ExternallyTraversible
...
class MySQLCompiler(compiler.SQLCompiler):
    ...
    def _render_json_extract_from_binary(
        ...
        if binary.type._type_affinity is sqltypes.Integer:
            ...
            # other affinity# CODE_TRUNCATED.this is not expected right now
...
class MySQLIdentifierPreparer(compiler.IdentifierPreparer):
    ...
    def _quote_free_identifiers(self, *ids: Optional[str]) -> Tuple[str, # CODE_TRUNCATED]:
...
class MySQLDialect(default.DefaultDialect):
    ...
    # identifiers are 64, however aliases can be 255# CODE_TRUNCATED
    ...
    # # CODE_TRUNCATED may be updated to True for MariaDB 10.3+ in initialize()
    supports_sequences = False

    sequences_optional = False

    # # CODE_TRUNCATED may be updated to True for MySQL 8+ in initialize()
    supports_for_update_of = False

    # mysql 8.0.1 uses this syntax
    use_mysql_for_share = False

    # Only available # CODE_TRUNCATED # CODE_TRUNCATED in MySQL 8+
    ...
    server_version_info: Tuple[int, # CODE_TRUNCATED]
    ...
    def __init__(
        self,
        json_serializer: Optional[Callable[# CODE_TRUNCATED, Any]] = None,
        json_deserializer: Optional[Callable[# CODE_TRUNCATED, Any]] = None,
    ...
    def _parse_server_version(self, val: str) -> Tuple[int, # CODE_TRUNCATED]:
        version: List[int] = []
        is_mariadb = False
    ...
    def _set_mariadb(
        self, is_mariadb: Optional[bool], server_version_info: Tuple[int, # CODE_TRUNCATED]
    ) -> None:
    ...
    def _correct_for_mysql_bugs_88718_96365(
        ...
        # NOTE: using (table_schema, table_name, lower(column_name)) in (# CODE_TRUNCATED)
    ...
    def _describe_table(
        ...
        charset: Optional[str],
        full_name: str,
    ) -> Union[Sequence[Row[Any]], Sequence[_DecodingRow]]: # CODE_TRUNCATED
