...
if TYPE_CHECKING:
    ...
    from # CODE_TRUNCATEDsql.elements import BinaryExpression
...
class MySQLDialect_mysqlconnector(MySQLDialect):
    ...
    def _mysqlconnector_version_info(self) -> Optional[Tuple[int, # CODE_TRUNCATED]]:
    ...
    def _compat_fetchall(
        self,
        rp: CursorResult[Tuple[Any, # CODE_TRUNCATED]],
        charset: Optional[str] = None,
    ) -> Sequence[Row[Tuple[Any, # CODE_TRUNCATED]]]:
        return rp.fetchall()
    ...
    def _compat_fetchone(
        ...
        rp: CursorResult[Tuple[Any, # CODE_TRUNCATED]],
        charset: Optional[str] = None,
    ) -> Optional[Row[Tuple[Any, # CODE_TRUNCATED]]]:
        return rp.fetchone()
