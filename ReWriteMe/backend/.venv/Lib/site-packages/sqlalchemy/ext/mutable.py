...
class MutableDict(Mutable, Dict[_KT, _VT]):
    ...
    *values themselves* inside the dictionary. Therefore it is not a sufficient
    ...
    if TYPE_CHECKING:
        ...
        @overload
        def setdefault(self, key: _KT, value: _VT) -> _VT: # CODE_TRUNCATED

        def setdefault(self, key: _KT, value: object = None) -> object: # CODE_TRUNCATED
    ...
    if TYPE_CHECKING:
        ...
        @overload
        def pop(self, __key: _KT, __default: _VT | _T) -> _VT | _T: # CODE_TRUNCATED

        def pop(
            self, __key: _KT, __default: _VT | _T | None = None
        ) -> _VT | _T: # CODE_TRUNCATED
