...
explicit table declaration::
    ...
    # such as 'only' to limit what tables we look at# CODE_TRUNCATED
    metadata.reflect(engine, only=["user", "address"])

    # # CODE_TRUNCATED or just define our own Table objects with it (or combine both)
    Table(
        "user_order",
        metadata,
...
class GenerateRelationshipType(Protocol):
    ...
    def __call__(
        ...
        return_fn: Callable[# CODE_TRUNCATED, Relationship[Any]],
        attrname: str,
        local_cls: Type[Any],
        referred_cls: Type[Any],
        **kw: Any,
    ) -> Relationship[Any]: # CODE_TRUNCATED
    ...
    def __call__(
        ...
        base: Type[Any],
        direction: RelationshipDirection,
        return_fn: Callable[# CODE_TRUNCATED, ORMBackrefArgument],
        attrname: str,
        local_cls: Type[Any],
        referred_cls: Type[Any],
        **kw: Any,
    ) -> ORMBackrefArgument: # CODE_TRUNCATED
    ...
    def __call__(
        ...
        direction: RelationshipDirection,
        return_fn: Union[
            Callable[# CODE_TRUNCATED, Relationship[Any]], Callable[# CODE_TRUNCATED, ORMBackrefArgument]
        ],
        attrname: str,
        local_cls: Type[Any],
        referred_cls: Type[Any],
        **kw: Any,
    ) -> Union[ORMBackrefArgument, Relationship[Any]]: # CODE_TRUNCATED
