...
def get_callexpr_kwarg(
    callexpr: CallExpr, name: str, *, expr_types: None = # CODE_TRUNCATED
) -> Optional[Union[CallExpr, NameExpr]]: # CODE_TRUNCATED
...
def get_callexpr_kwarg(
    ...
    name: str,
    *,
    expr_types: Tuple[TypingType[_TArgType], # CODE_TRUNCATED],
) -> Optional[_TArgType]: # CODE_TRUNCATED
...
def get_callexpr_kwarg(
    ...
    name: str,
    *,
    expr_types: Optional[Tuple[TypingType[Any], # CODE_TRUNCATED]] = None,
) -> Optional[Any]:
    try:
...
def unbound_to_instance(
    ...
    if typ.name == "Optional":
        ...
        # UnionType[# CODE_TRUNCATED, NoneType()]
