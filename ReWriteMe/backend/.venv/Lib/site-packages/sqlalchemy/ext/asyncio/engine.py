...
from # CODE_TRUNCATED import inspection
from # CODE_TRUNCATED import util
from # CODE_TRUNCATEDengine import Connection
from # CODE_TRUNCATEDengine import create_engine as _create_engine
from # CODE_TRUNCATEDengine import create_pool_from_url as _create_pool_from_url
from # CODE_TRUNCATEDengine import Engine
from # CODE_TRUNCATEDengine.base import NestedTransaction
from # CODE_TRUNCATEDengine.base import Transaction
from # CODE_TRUNCATEDexc import ArgumentError
from # CODE_TRUNCATEDutil.concurrency import greenlet_spawn
from # CODE_TRUNCATEDutil.typing import Concatenate
from # CODE_TRUNCATEDutil.typing import ParamSpec

if TYPE_CHECKING:
    from # CODE_TRUNCATEDengine.cursor import CursorResult
    from # CODE_TRUNCATEDengine.interfaces import _CoreAnyExecuteParams
    from # CODE_TRUNCATEDengine.interfaces import _CoreSingleExecuteParams
    from # CODE_TRUNCATEDengine.interfaces import _DBAPIAnyExecuteParams
    from # CODE_TRUNCATEDengine.interfaces import _ExecuteOptions
    from # CODE_TRUNCATEDengine.interfaces import CompiledCacheType
    from # CODE_TRUNCATEDengine.interfaces import CoreExecuteOptionsParameter
    from # CODE_TRUNCATEDengine.interfaces import Dialect
    from # CODE_TRUNCATEDengine.interfaces import IsolationLevel
    from # CODE_TRUNCATEDengine.interfaces import SchemaTranslateMapType
    from # CODE_TRUNCATEDengine.result import ScalarResult
    from # CODE_TRUNCATEDengine.url import URL
    from # CODE_TRUNCATEDpool import Pool
    from # CODE_TRUNCATEDpool import PoolProxiedConnection
    from # CODE_TRUNCATEDsql._typing import _InfoType
    from # CODE_TRUNCATEDsql.base import Executable
    from # CODE_TRUNCATEDsql.selectable import TypedReturnsRows
...
class AsyncConnection(  # type:ignore[misc]
    ...
    async def execution_options(
        self,
        *,
        compiled_cache: Optional[CompiledCacheType] = # CODE_TRUNCATED,
        logging_token: str = # CODE_TRUNCATED,
        isolation_level: IsolationLevel = # CODE_TRUNCATED,
        no_parameters: bool = False,
        stream_results: bool = False,
        max_row_buffer: int = # CODE_TRUNCATED,
        yield_per: int = # CODE_TRUNCATED,
        insertmanyvalues_page_size: int = # CODE_TRUNCATED,
        schema_translate_map: Optional[SchemaTranslateMapType] = # CODE_TRUNCATED,
        preserve_rowcount: bool = False,
        **opt: Any,
    ) -> AsyncConnection: # CODE_TRUNCATED

    @overload
    async def execution_options(self, **opt: Any) -> AsyncConnection: # CODE_TRUNCATED
    ...
    def stream(
        ...
        *,
        execution_options: Optional[CoreExecuteOptionsParameter] = None,
    ) -> GeneratorStartableContext[AsyncResult[_T]]: # CODE_TRUNCATED
    ...
    def stream(
        ...
        *,
        execution_options: Optional[CoreExecuteOptionsParameter] = None,
    ) -> GeneratorStartableContext[AsyncResult[Any]]: # CODE_TRUNCATED
    ...
    async def execute(
        ...
        *,
        execution_options: Optional[CoreExecuteOptionsParameter] = None,
    ) -> CursorResult[_T]: # CODE_TRUNCATED
    ...
    async def execute(
        ...
        *,
        execution_options: Optional[CoreExecuteOptionsParameter] = None,
    ) -> CursorResult[Any]: # CODE_TRUNCATED
    ...
    async def scalars(
        ...
        *,
        execution_options: Optional[CoreExecuteOptionsParameter] = None,
    ) -> ScalarResult[_T]: # CODE_TRUNCATED
    ...
    async def scalars(
        ...
        *,
        execution_options: Optional[CoreExecuteOptionsParameter] = None,
    ) -> ScalarResult[Any]: # CODE_TRUNCATED
    ...
    def stream_scalars(
        ...
        *,
        execution_options: Optional[CoreExecuteOptionsParameter] = None,
    ) -> GeneratorStartableContext[AsyncScalarResult[_T]]: # CODE_TRUNCATED
    ...
    def stream_scalars(
        ...
        *,
        execution_options: Optional[CoreExecuteOptionsParameter] = None,
    ) -> GeneratorStartableContext[AsyncScalarResult[Any]]: # CODE_TRUNCATED
...
class AsyncEngine(ProxyComparable[Engine], AsyncConnectable):  # type: ignore[misc]  # noqa:E501
    ...
    def execution_options(
        ...
        *,
        ...
        schema_translate_map: Optional[SchemaTranslateMapType] = # CODE_TRUNCATED,
        **opt: Any,
    ) -> AsyncEngine: # CODE_TRUNCATED

    @overload
    def execution_options(self, **opt: Any) -> AsyncEngine: # CODE_TRUNCATED
...
@overload
def _get_sync_engine_or_connection(async_engine: AsyncEngine) -> Engine: # CODE_TRUNCATED


@overload
def _get_sync_engine_or_connection(
    async_engine: AsyncConnection,
) -> Connection: # CODE_TRUNCATED
