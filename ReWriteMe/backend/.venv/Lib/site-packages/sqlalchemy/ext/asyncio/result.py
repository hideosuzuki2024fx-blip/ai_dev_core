...
from # CODE_TRUNCATEDengine.result import _NO_ROW
from # CODE_TRUNCATEDengine.result import _R
from # CODE_TRUNCATEDengine.result import _WithKeys
from # CODE_TRUNCATEDengine.result import FilterResult
from # CODE_TRUNCATEDengine.result import FrozenResult
from # CODE_TRUNCATEDengine.result import ResultMetaData
from # CODE_TRUNCATEDengine.row import Row
from # CODE_TRUNCATEDengine.row import RowMapping
from # CODE_TRUNCATEDsql.base import _generative
from # CODE_TRUNCATEDutil.concurrency import greenlet_spawn
from # CODE_TRUNCATEDutil.typing import Literal
from # CODE_TRUNCATEDutil.typing import Self

if TYPE_CHECKING:
    from # CODE_TRUNCATEDengine import CursorResult
    from # CODE_TRUNCATEDengine.result import _KeyIndexType
    from # CODE_TRUNCATEDengine.result import _UniqueFilterType
...
class AsyncResult(_WithKeys, AsyncCommon[Row[_TP]]):
    ...
    @overload
    async def scalar_one(self: AsyncResult[Tuple[_T]]) -> _T: # CODE_TRUNCATED

    @overload
    async def scalar_one(self) -> Any: # CODE_TRUNCATED
    ...
    @overload
    async def scalar_one_or_none(self) -> Optional[Any]: # CODE_TRUNCATED
    ...
    @overload
    async def scalar(self: AsyncResult[Tuple[_T]]) -> Optional[_T]: # CODE_TRUNCATED

    @overload
    async def scalar(self) -> Any: # CODE_TRUNCATED
    ...
    @overload
    def scalars(self: AsyncResult[Tuple[_T]]) -> AsyncScalarResult[_T]: # CODE_TRUNCATED

    @overload
    def scalars(self, index: _KeyIndexType = 0) -> AsyncScalarResult[Any]: # CODE_TRUNCATED
...
class AsyncTupleResult(AsyncCommon[_R], util.TypingOnly):
    ...
    if TYPE_CHECKING:
        ...
        def __aiter__(self) -> AsyncIterator[_R]: # CODE_TRUNCATED

        async def __anext__(self) -> _R: # CODE_TRUNCATED
        ...
        @overload
        async def scalar_one(self: AsyncTupleResult[Tuple[_T]]) -> _T: # CODE_TRUNCATED
