...
Unless you set a default value::
    ...
    >>> class Person(Base):
    # CODE_TRUNCATED     __tablename__ = "person"
    # CODE_TRUNCATED
    # CODE_TRUNCATED     id = Column(Integer, primary_key=True)
    # CODE_TRUNCATED     data = Column(JSON)
    # CODE_TRUNCATED
    # CODE_TRUNCATED     name = index_property("data", "name", default=None)  # See default
