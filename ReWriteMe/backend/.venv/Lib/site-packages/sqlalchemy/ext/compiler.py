...
invoked for the dialect in use::
    ...
    def visit_alter_column(element, compiler, **kw):
        return "ALTER COLUMN %s # CODE_TRUNCATED" % element.column.name


    @compiles(AlterColumn, "postgresql")
    def visit_alter_column(element, compiler, **kw):
        return "ALTER TABLE %s ALTER COLUMN %s # CODE_TRUNCATED" % (
            element.table.name,
            element.column.name,
        )
...
class _dispatcher:
    def __init__(self) -> None:
        self.specs: Dict[str, Callable[# CODE_TRUNCATED, Any]] = {}
