...
class _GetterProtocol(Protocol[_T_co]):
    def __call__(self, instance: Any) -> _T_co: # CODE_TRUNCATED


# mypy 0.990 we are no longer allowed to make this Protocol[_T_con]
class _SetterProtocol(Protocol): # CODE_TRUNCATED


class _PlainSetterProtocol(_SetterProtocol, Protocol[_T_con]):
    def __call__(self, instance: Any, value: _T_con) -> None: # CODE_TRUNCATED


class _DictSetterProtocol(_SetterProtocol, Protocol[_T_con]):
    def __call__(self, instance: Any, key: Any, value: _T_con) -> None: # CODE_TRUNCATED


# mypy 0.990 we are no longer allowed to make this Protocol[_T_con]
class _CreatorProtocol(Protocol): # CODE_TRUNCATED


class _PlainCreatorProtocol(_CreatorProtocol, Protocol[_T_con]):
    def __call__(self, value: _T_con) -> Any: # CODE_TRUNCATED


class _KeyCreatorProtocol(_CreatorProtocol, Protocol[_T_con]):
    def __call__(self, key: Any, value: Optional[_T_con]) -> Any: # CODE_TRUNCATED
...
class _GetSetFactoryProtocol(Protocol):
    ...
    ) -> Tuple[_GetterProtocol[Any], _SetterProtocol]: # CODE_TRUNCATED
...
class _AssociationProxyProtocol(Protocol[_T]):
    ...
    def info(self) -> _InfoType: # CODE_TRUNCATED

    def for_class(
        self, class_: Type[Any], obj: Optional[object] = None
    ) -> AssociationProxyInstance[_T]: # CODE_TRUNCATED
...
class AssociationProxyInstance(SQLORMOperations[_T]):
    ...
    @overload
    def get(self: _Self, obj: Literal[None]) -> _Self: # CODE_TRUNCATED

    @overload
    def get(self, obj: Any) -> _T: # CODE_TRUNCATED
...
class _AssociationList(_AssociationSingleItem[_T], MutableSequence[_T]):
    ...
    @overload
    def __getitem__(self, index: int) -> _T: # CODE_TRUNCATED

    @overload
    def __getitem__(self, index: slice) -> MutableSequence[_T]: # CODE_TRUNCATED
    ...
    @overload
    def __setitem__(self, index: int, value: _T) -> None: # CODE_TRUNCATED

    @overload
    def __setitem__(self, index: slice, value: Iterable[_T]) -> None: # CODE_TRUNCATED
    ...
    @overload
    def __delitem__(self, index: int) -> None: # CODE_TRUNCATED

    @overload
    def __delitem__(self, index: slice) -> None: # CODE_TRUNCATED
    ...
    if typing.TYPE_CHECKING:
        ...
        def index(
            self, value: Any, start: int = # CODE_TRUNCATED, stop: int = # CODE_TRUNCATED
        ) -> int: # CODE_TRUNCATED
...
class _AssociationDict(_AssociationCollection[_VT], MutableMapping[_KT, _VT]):
    ...
    @overload
    def get(self, __key: _KT) -> Optional[_VT]: # CODE_TRUNCATED

    @overload
    def get(self, __key: _KT, default: Union[_VT, _T]) -> Union[_VT, _T]: # CODE_TRUNCATED
    ...
    @overload
    def pop(self, __key: _KT) -> _VT: # CODE_TRUNCATED

    @overload
    def pop(
        self, __key: _KT, default: Union[_VT, _T] = # CODE_TRUNCATED
    ) -> Union[_VT, _T]: # CODE_TRUNCATED
    ...
    @overload
    def update(self, **kwargs: _VT) -> None: # CODE_TRUNCATED
