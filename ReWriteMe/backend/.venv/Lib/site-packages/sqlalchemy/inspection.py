...
class _InspectableTypeProtocol(Protocol[_TCov]):
    ...
    def _sa_inspect_type(self) -> _TCov: # CODE_TRUNCATED
...
class _InspectableProtocol(Protocol[_TCov]):
    ...
    def _sa_inspect_instance(self) -> _TCov: # CODE_TRUNCATED
...
@overload
def inspect(subject: Inspectable[_IN], raiseerr: bool = True) -> _IN: # CODE_TRUNCATED


@overload
def inspect(subject: Any, raiseerr: Literal[False] = # CODE_TRUNCATED) -> Optional[Any]: # CODE_TRUNCATED


@overload
def inspect(subject: Any, raiseerr: bool = True) -> Any: # CODE_TRUNCATED
