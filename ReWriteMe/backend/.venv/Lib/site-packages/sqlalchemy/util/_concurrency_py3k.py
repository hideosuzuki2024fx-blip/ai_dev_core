...
if typing.TYPE_CHECKING:
    ...
    class greenlet(Protocol):
        ...
        def __init__(self, fn: Callable[# CODE_TRUNCATED, Any], driver: greenlet): # CODE_TRUNCATED
    ...
    def getcurrent() -> greenlet: # CODE_TRUNCATED
...
class _AsyncIoGreenlet(greenlet):
    ...
    def __init__(self, fn: Callable[# CODE_TRUNCATED, Any], driver: greenlet):
...
if TYPE_CHECKING:
    ...
    ) -> TypeGuard[Coroutine[Any, Any, _T_co]]: # CODE_TRUNCATED
...
def get_event_loop() -> asyncio.AbstractEventLoop:
    ...
    try:
        ...
        # avoid "During handling of the above exception, another exception# CODE_TRUNCATED"
        pass
