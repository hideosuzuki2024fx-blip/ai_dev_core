...
def combinations(
    *comb: Union[Any, Tuple[Any, # CODE_TRUNCATED]],
...
def combinations_list(arg_iterable: Iterable[Tuple[Any, # CODE_TRUNCATED]], **kw):
...
class Variation:
    ...
    if typing.TYPE_CHECKING:
        ...
        def __getattr__(self, key: str) -> bool: # CODE_TRUNCATED
