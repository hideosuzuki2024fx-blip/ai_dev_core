...
class SuiteRequirements(Requirements):
    ...
    def table_value_constructor(self):
        ...
        .. sourcecode:: sql
             ...
             SELECT * FROM VALUES ( (c1, c2), (c1, c2), # CODE_TRUNCATED)
    ...
    def parens_in_union_contained_select_w_limit_offset(self):
        ...
        E.g. (SELECT # CODE_TRUNCATED) UNION (SELECT ..)
    ...
    def parens_in_union_contained_select_wo_limit_offset(self):
        ...
        E.g. (SELECT # CODE_TRUNCATED LIMIT ..) UNION (SELECT .. OFFSET ..)
    ...
    def ctes_on_dml(self):
        ...
        or DELETE *within* the CTE, e.g. WITH x AS (UPDATE# CODE_TRUNCATED.)"""
    ...
    def delete_returning(self):
        """target platform supports DELETE # CODE_TRUNCATED RETURNING."""

        return exclusions.only_if(
            lambda config: config.db.dialect.delete_returning,
            "%(database)s %(does_support)s 'DELETE # CODE_TRUNCATED RETURNING'",
        )

    @property
    def insert_returning(self):
        """target platform supports INSERT # CODE_TRUNCATED RETURNING."""

        return exclusions.only_if(
            lambda config: config.db.dialect.insert_returning,
            "%(database)s %(does_support)s 'INSERT # CODE_TRUNCATED RETURNING'",
        )

    @property
    def update_returning(self):
        """target platform supports UPDATE # CODE_TRUNCATED RETURNING."""

        return exclusions.only_if(
            lambda config: config.db.dialect.update_returning,
            "%(database)s %(does_support)s 'UPDATE # CODE_TRUNCATED RETURNING'",
        )
    ...
    def tuple_in(self):
        ...
        "(x, y) IN ((x1, y1), (x2, y2), # CODE_TRUNCATED)"
        """
    ...
    def order_by_col_from_union(self):
        ...
        .. sourcecode:: sql
            ...
            (SELECT id, # CODE_TRUNCATED) UNION (SELECT id, # CODE_TRUNCATED) ORDER BY id
