...
class SerializationInfo(Protocol[ContextT]):
    ...
    def mode_is_json(self) -> bool: # CODE_TRUNCATED

    def __str__(self) -> str: # CODE_TRUNCATED

    def __repr__(self) -> str: # CODE_TRUNCATED
...
class SerializerFunctionWrapHandler(Protocol):  # pragma: no cover
    def __call__(self, input_value: Any, index_key: int | str | None = None, /) -> Any: # CODE_TRUNCATED
...
class CallSchema(TypedDict, total=False):
    ...
    function: Required[Callable[# CODE_TRUNCATED, Any]]
