...
class WSGIMiddleware:
    def __init__(self, app: Callable[# CODE_TRUNCATED, Any]) -> None:
        self.app = app
...
class WSGIResponder:
    ...
    def __init__(self, app: Callable[# CODE_TRUNCATED, Any], scope: Scope) -> None:
        self.app = app
        self.scope = scope
        self.status = None
    ...
    def wsgi(
        ...
        start_response: Callable[# CODE_TRUNCATED, Any],
    ) -> None:
