...
T = TypeVar("T")
AwaitableCallable = Callable[# CODE_TRUNCATED, Awaitable[T]]


@overload
def is_async_callable(obj: AwaitableCallable[T]) -> TypeIs[AwaitableCallable[T]]: # CODE_TRUNCATED


@overload
def is_async_callable(obj: Any) -> TypeIs[AwaitableCallable[Any]]: # CODE_TRUNCATED
...
class AwaitableOrContextManager(Awaitable[T_co], AbstractAsyncContextManager[T_co], Protocol[T_co]): # CODE_TRUNCATED


class SupportsAsyncClose(Protocol):
    async def close(self) -> None: # CODE_TRUNCATED  # pragma: no cover
