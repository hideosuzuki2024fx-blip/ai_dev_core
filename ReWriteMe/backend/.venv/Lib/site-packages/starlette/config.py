...
class Config:
    ...
    @overload
    def __call__(self, key: str, *, default: None) -> str | None: # CODE_TRUNCATED

    @overload
    def __call__(self, key: str, cast: type[T], default: T = # CODE_TRUNCATED) -> T: # CODE_TRUNCATED

    @overload
    def __call__(self, key: str, cast: type[str] = # CODE_TRUNCATED, default: str = # CODE_TRUNCATED) -> str: # CODE_TRUNCATED

    @overload
    def __call__(
        self,
        key: str,
        cast: Callable[[Any], T] = # CODE_TRUNCATED,
        default: Any = # CODE_TRUNCATED,
    ) -> T: # CODE_TRUNCATED

    @overload
    def __call__(self, key: str, cast: type[str] = # CODE_TRUNCATED, default: T = # CODE_TRUNCATED) -> T | str: # CODE_TRUNCATED
