...
def get_name(endpoint: Callable[# CODE_TRUNCATED, Any]) -> str:
...
class Route(BaseRoute):
    def __init__(
        self,
        path: str,
        endpoint: Callable[# CODE_TRUNCATED, Any],
        *,
...
class Mount(BaseRoute):
    def __init__(
        ...
        *,
        ...
        assert app is not None or routes is not None, "Either 'app=# CODE_TRUNCATED', or 'routes=' must be specified"
...
class Router:
    ...
    def route(
        ...
        >>> routes = [Route(path, endpoint=# CODE_TRUNCATED), # CODE_TRUNCATED]
    ...
    def websocket_route(self, path: str, name: str | None = None) -> Callable:  # type: ignore[type-arg]
        ...
        >>> routes = [WebSocketRoute(path, endpoint=# CODE_TRUNCATED), # CODE_TRUNCATED]
        >>> app = Starlette(routes=routes)
        """
        warnings.warn(
