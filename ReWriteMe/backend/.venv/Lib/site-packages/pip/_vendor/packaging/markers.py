...
def _format_marker(
    ...
    # Sometimes we have a structure like [[# CODE_TRUNCATED]] which is a single item list
...
def _normalize(*values: str, key: str) -> tuple[str, # CODE_TRUNCATED]:
...
class Marker:
    def __init__(self, marker: str) -> None:
        ...
        try:
            ...
            # MarkerList = List[Union[Tuple[Node, # CODE_TRUNCATED], str, MarkerList]]
            #
