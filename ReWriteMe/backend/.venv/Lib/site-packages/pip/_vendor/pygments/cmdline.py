...
def main_inner(parser, argns):
    ...
    # # CODE_TRUNCATED and do it!
    if not argns.s:
        # process whole input as per normal# CODE_TRUNCATED
        try:
        ...
        # line by line processing of stdin (eg: for 'tail -f')# CODE_TRUNCATED
        try:
            while 1:
...
def main(args=sys.argv):
    ...
    operation.add_argument(
        '-O', metavar='OPTION=value[,OPTION=value,# CODE_TRUNCATED]', action='append',
