...
class LatexFormatter(Formatter):
    ...
    `mathescape`
        ...
        is, ``'$# CODE_TRUNCATED$'`` inside a comment will trigger math mode (default:
        ``False``).
    ...
    def format_unencoded(self, tokensource, outfile):
        ...
        for ttype, value in tokensource:
            if ttype in Token.Comment:
                if self.texcomments:
                    # Try to guess comment starting lexeme and escape it # CODE_TRUNCATED
                    start = value[0:1]
                    ...
                    # # CODE_TRUNCATED but do not escape inside comment.
                    value = start + value
