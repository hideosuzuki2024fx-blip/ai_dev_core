...
class SSLContext(_truststore_SSLContext_super_class):  # type: ignore[misc]
    ...
    @typing.overload
    def get_ca_certs(
        self, binary_form: typing.Literal[False] = # CODE_TRUNCATED
    ) -> list[typing.Any]: # CODE_TRUNCATED

    @typing.overload
    def get_ca_certs(self, binary_form: typing.Literal[True] = # CODE_TRUNCATED) -> list[bytes]: # CODE_TRUNCATED

    @typing.overload
    def get_ca_certs(self, binary_form: bool = # CODE_TRUNCATED) -> typing.Any: # CODE_TRUNCATED
