...
def group(fit: bool = True) -> Callable[# CODE_TRUNCATED, Callable[# CODE_TRUNCATED, Group]]:
    ...
    def decorator(
        method: Callable[# CODE_TRUNCATED, Iterable[RenderableType]]
    ) -> Callable[# CODE_TRUNCATED, Group]:
...
class Console:
    ...
    def capture(self) -> Capture:
        ...
        Example:
            ...
            # CODE_TRUNCATED     console.print("[bold magenta]Hello World[/]")
            >>> print(capture.get())
