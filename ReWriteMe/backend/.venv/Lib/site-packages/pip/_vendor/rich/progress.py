...
def track(
    ...
    description: str = "Working# CODE_TRUNCATED",
...
def wrap_file(
    ...
    total: int,
    *,
    description: str = "Reading# CODE_TRUNCATED",
    auto_refresh: bool = True,
    console: Optional[Console] = None,
    transient: bool = False,
    get_time: Optional[Callable[[], float]] = None,
...
class Progress(JupyterMixin):
    ...
    @classmethod
    def get_default_columns(cls) -> Tuple[ProgressColumn, # CODE_TRUNCATED]:
...
if __name__ == "__main__":  # pragma: no coverage
    ...
    progress_renderables = [
        ...
        "Such as [magenta]tables[/]# CODE_TRUNCATED",
        table,
        "Pretty printed structures# CODE_TRUNCATED",
        {"type": "example", "text": "Pretty printed"},
        "Syntax# CODE_TRUNCATED",
        syntax,
        Rule("Give it a try!"),
    ]
