...
from # CODE_TRUNCATED_types import Omit
from # CODE_TRUNCATED_utils import is_given
...
from # CODE_TRUNCATEDtypes.chat.completion_create_params import ResponseFormat
