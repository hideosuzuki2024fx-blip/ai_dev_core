...
from # CODE_TRUNCATED_utils import is_dict, is_list, consume_sync_iterator, consume_async_iterator
from # CODE_TRUNCATED_compat import model_dump
from # CODE_TRUNCATED_models import construct_type
from # CODE_TRUNCATED_streaming import Stream, AsyncStream
from # CODE_TRUNCATEDtypes.beta import AssistantStreamEvent
from # CODE_TRUNCATEDtypes.beta.threads import (
    Run,
    Text,
    Message,
    ImageFile,
...
from # CODE_TRUNCATEDtypes.beta.threads.runs import RunStep, ToolCall, RunStepDelta, ToolCallDelta
...
class AssistantStreamManager(Generic[AssistantEventHandlerT]):
    ...
    ```py
    with client.threads.create_and_run_stream(# CODE_TRUNCATED) as stream:
        for event in stream:
            # CODE_TRUNCATED
    ```
    """
...
class AsyncAssistantStreamManager(Generic[AsyncAssistantEventHandlerT]):
    ...
    ```py
    async with client.threads.create_and_run_stream(# CODE_TRUNCATED) as stream:
        async for event in stream:
            # CODE_TRUNCATED
    ```
    """
