...
from # CODE_TRUNCATED._types import NOT_GIVEN, Query, Headers, NotGiven
...
from # CODE_TRUNCATED._models import construct_type_unchecked
from # CODE_TRUNCATED._resource import SyncAPIResource, AsyncAPIResource
from # CODE_TRUNCATED._exceptions import OpenAIError
from # CODE_TRUNCATED._base_client import _merge_mappings
from # CODE_TRUNCATED.types.beta.realtime import (
...
from # CODE_TRUNCATED.types.websocket_connection_options import WebsocketConnectionOptions
from # CODE_TRUNCATED.types.beta.realtime.realtime_client_event import RealtimeClientEvent
from # CODE_TRUNCATED.types.beta.realtime.realtime_server_event import RealtimeServerEvent
from # CODE_TRUNCATED.types.beta.realtime.conversation_item_param import ConversationItemParam
from # CODE_TRUNCATED.types.beta.realtime.realtime_client_event_param import RealtimeClientEventParam

if TYPE_CHECKING:
    from websockets.sync.client import ClientConnection as WebsocketConnection
    from websockets.asyncio.client import ClientConnection as AsyncWebsocketConnection

    from # CODE_TRUNCATED._client import OpenAI, AsyncOpenAI
...
class AsyncRealtimeConnectionManager:
    ...
    **Warning**: You must remember to close the connection with `.close()`.
    ...
    ```py
    connection = await client.beta.realtime.connect(# CODE_TRUNCATED).enter()
    # # CODE_TRUNCATED
...
class RealtimeConnectionManager:
    ...
    **Warning**: You must remember to close the connection with `.close()`.
    ...
    ```py
    connection = client.beta.realtime.connect(# CODE_TRUNCATED).enter()
    # # CODE_TRUNCATED
    connection.close()
    ```
    """
