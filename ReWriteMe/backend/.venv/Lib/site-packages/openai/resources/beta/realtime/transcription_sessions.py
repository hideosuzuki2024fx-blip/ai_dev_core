...
from # CODE_TRUNCATED._types import NOT_GIVEN, Body, Query, Headers, NotGiven
...
from # CODE_TRUNCATED.types.beta.realtime import transcription_session_create_params
from # CODE_TRUNCATED.types.beta.realtime.transcription_session import TranscriptionSession
