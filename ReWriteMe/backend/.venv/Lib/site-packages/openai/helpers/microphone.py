...
class Microphone(Generic[DType]):
    ...
    @overload
    async def record(self, return_ndarray: Literal[True]) -> npt.NDArray[DType]: # CODE_TRUNCATED

    @overload
    async def record(self, return_ndarray: Literal[False]) -> FileTypes: # CODE_TRUNCATED

    @overload
    async def record(self, return_ndarray: None = # CODE_TRUNCATED) -> FileTypes: # CODE_TRUNCATED
