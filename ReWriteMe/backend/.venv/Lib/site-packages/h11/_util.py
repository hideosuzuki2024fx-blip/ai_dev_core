...
# be raised (send(), all the different event constructors, # CODE_TRUNCATED), and only one
...
class Sentinel(type):
    def __new__(
        ...
        name: str,
        bases: Tuple[type, # CODE_TRUNCATED],
...
# values. Accepts ascii-strings, or bytes/bytearray/memoryview/# CODE_TRUNCATED, and always
# returns bytes.
