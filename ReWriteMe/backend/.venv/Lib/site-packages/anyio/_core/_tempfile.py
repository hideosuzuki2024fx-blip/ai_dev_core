...
class TemporaryFile(Generic[AnyStr]):
    ...
    def __init__(
        ...
        mode: OpenBinaryMode = # CODE_TRUNCATED,
        buffering: int = # CODE_TRUNCATED,
        encoding: str | None = # CODE_TRUNCATED,
        newline: str | None = # CODE_TRUNCATED,
        suffix: str | None = # CODE_TRUNCATED,
        prefix: str | None = # CODE_TRUNCATED,
        dir: str | None = # CODE_TRUNCATED,
        *,
        errors: str | None = # CODE_TRUNCATED,
    ): # CODE_TRUNCATED
    @overload
    def __init__(
...
class NamedTemporaryFile(Generic[AnyStr]):
    ...
    def __init__(
        ...
        prefix: str | None = # CODE_TRUNCATED,
        dir: str | None = # CODE_TRUNCATED,
        delete: bool = # CODE_TRUNCATED,
        *,
        errors: str | None = # CODE_TRUNCATED,
        delete_on_close: bool = # CODE_TRUNCATED,
    ): # CODE_TRUNCATED
    @overload
    def __init__(
...
class SpooledTemporaryFile(AsyncFile[AnyStr]):
    ...
    def __init__(
        ...
        max_size: int = # CODE_TRUNCATED,
        mode: OpenTextMode = # CODE_TRUNCATED,
        buffering: int = # CODE_TRUNCATED,
        encoding: str | None = # CODE_TRUNCATED,
        newline: str | None = # CODE_TRUNCATED,
        suffix: str | None = # CODE_TRUNCATED,
    ...
    @overload
    async def write(self: SpooledTemporaryFile[bytes], b: ReadableBuffer) -> int: # CODE_TRUNCATED
    @overload
    async def write(self: SpooledTemporaryFile[str], b: str) -> int: # CODE_TRUNCATED
...
async def mkstemp(
    ...
    dir: bytes | None = None,
    text: bool = False,
) -> tuple[int, bytes]: # CODE_TRUNCATED
