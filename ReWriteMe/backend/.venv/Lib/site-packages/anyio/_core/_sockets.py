...
async def connect_tcp(
    ...
    remote_port: int,
    *,
    local_host: IPAddressType | None = # CODE_TRUNCATED,
    ssl_context: ssl.SSLContext | None = # CODE_TRUNCATED,
    tls_standard_compatible: bool = # CODE_TRUNCATED,
    tls_hostname: str,
    happy_eyeballs_delay: float = # CODE_TRUNCATED,
) -> TLSStream: # CODE_TRUNCATED
...
async def connect_tcp(
    ...
    *,
    ...
    tls_standard_compatible: bool = # CODE_TRUNCATED,
    tls_hostname: str | None = # CODE_TRUNCATED,
    happy_eyeballs_delay: float = # CODE_TRUNCATED,
) -> TLSStream: # CODE_TRUNCATED
...
async def getaddrinfo(
    ...
    *,
    ...
    :param family: socket family (`'AF_INET``, # CODE_TRUNCATED)
    :param type: socket type (``SOCK_STREAM``, # CODE_TRUNCATED)
...
async def setup_unix_local_socket(
    ...
    if path is not None:
        ...
        if not path_str.startswith("\0"):
            # Copied from pathlib# CODE_TRUNCATED
            try:
