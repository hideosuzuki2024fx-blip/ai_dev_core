...
class AsyncFile(AsyncResource, Generic[AnyStr]):
    ...
    * flush
    ...
    This class also supports asynchronous iteration::
        ...
        async with await open_file(# CODE_TRUNCATED) as f:
            async for line in f:
                print(line)
    """
    ...
    @overload
    async def write(self: AsyncFile[bytes], b: ReadableBuffer) -> int: # CODE_TRUNCATED

    @overload
    async def write(self: AsyncFile[str], b: str) -> int: # CODE_TRUNCATED
    ...
    @overload
    async def writelines(self: AsyncFile[str], lines: Iterable[str]) -> None: # CODE_TRUNCATED
...
async def open_file(
    ...
    closefd: bool = # CODE_TRUNCATED,
    opener: Callable[[str, int], int] | None = # CODE_TRUNCATED,
) -> AsyncFile[bytes]: # CODE_TRUNCATED
...
class Path:
    ...
    * :meth:`~pathlib.Path.rglob`
    ...
    @property
    def parts(self) -> tuple[str, # CODE_TRUNCATED]:
