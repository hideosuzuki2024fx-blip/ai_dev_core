...
class TaskGroup(abc.TaskGroup):
    ...
    async def start(
        self, func: Callable[# CODE_TRUNCATED, Awaitable[Any]], *args: object, name: object = None
    ) -> Any:
        if not self._active:
            raise RuntimeError(
                "This task group is not active; no new tasks can be started."
...
class _SignalReceiver:
    ...
    def __init__(self, signals: tuple[Signals, # CODE_TRUNCATED]):
...
class TestRunner(abc.TestRunner):
    ...
    def run_asyncgen_fixture(
        self,
        fixture_func: Callable[# CODE_TRUNCATED, AsyncGenerator[T_Retval, Any]],
        kwargs: dict[str, Any],
    ) -> Iterable[T_Retval]:
    ...
    def run_fixture(
        self,
        fixture_func: Callable[# CODE_TRUNCATED, Coroutine[Any, Any, T_Retval]],
        kwargs: dict[str, Any],
    ) -> T_Retval:
        return self._call_in_runner_task(fixture_func, **kwargs)

    def run_test(
        self, test_func: Callable[# CODE_TRUNCATED, Coroutine[Any, Any, Any]], kwargs: dict[str, Any]
    ) -> None:
...
class TrioBackend(AsyncBackend):
    ...
    ) -> abc.UNIXDatagramSocket: # CODE_TRUNCATED

    @classmethod
    @overload
    async def create_unix_datagram_socket(
        cls, raw_socket: socket.socket, remote_path: str | bytes
    ) -> abc.ConnectedUNIXDatagramSocket: # CODE_TRUNCATED
