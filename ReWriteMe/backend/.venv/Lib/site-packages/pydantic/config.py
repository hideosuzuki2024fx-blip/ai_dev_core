...
class ConfigDict(TypedDict, total=False):
    ...
    ignored_types: tuple[type, # CODE_TRUNCATED]
    ...
    protected_namespaces: tuple[str | Pattern[str], # CODE_TRUNCATED]
    """
    ...
    [`Model.model_rebuild(_types_namespace=# CODE_TRUNCATED)`][pydantic.BaseModel.model_rebuild].
...
def with_config(*, config: ConfigDict) -> Callable[[_TypeT], _TypeT]: # CODE_TRUNCATED
...
@overload
def with_config(**config: Unpack[ConfigDict]) -> Callable[[_TypeT], _TypeT]: # CODE_TRUNCATED
