...
def field_serializer(
    ...
    *fields: str,
    mode: Literal['wrap'],
    return_type: Any = # CODE_TRUNCATED,
    when_used: WhenUsed = # CODE_TRUNCATED,
    check_fields: bool | None = # CODE_TRUNCATED,
) -> Callable[[_FieldWrapSerializerT], _FieldWrapSerializerT]: # CODE_TRUNCATED
...
def field_serializer(
    ...
    /,
    *fields: str,
    mode: Literal['plain'] = # CODE_TRUNCATED,
    return_type: Any = # CODE_TRUNCATED,
    when_used: WhenUsed = # CODE_TRUNCATED,
    check_fields: bool | None = # CODE_TRUNCATED,
) -> Callable[[_FieldPlainSerializerT], _FieldPlainSerializerT]: # CODE_TRUNCATED
...
@overload
def model_serializer(f: _ModelPlainSerializerT, /) -> _ModelPlainSerializerT: # CODE_TRUNCATED


@overload
def model_serializer(
    *, mode: Literal['wrap'], when_used: WhenUsed = 'always', return_type: Any = # CODE_TRUNCATED
) -> Callable[[_ModelWrapSerializerT], _ModelWrapSerializerT]: # CODE_TRUNCATED
...
def model_serializer(
    *,
    ...
    when_used: WhenUsed = 'always',
    return_type: Any = # CODE_TRUNCATED,
) -> Callable[[_ModelPlainSerializerT], _ModelPlainSerializerT]: # CODE_TRUNCATED
...
if TYPE_CHECKING:
    SerializeAsAny = Annotated[AnyType, # CODE_TRUNCATED]  # SerializeAsAny[list[str]] will be treated by type checkers as list[str]
