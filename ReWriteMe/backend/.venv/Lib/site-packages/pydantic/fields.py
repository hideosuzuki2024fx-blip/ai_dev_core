...
class FieldInfo(_repr.Representation):
    ...
    @overload
    def get_default(self, *, call_default_factory: Literal[False] = # CODE_TRUNCATED) -> Any: # CODE_TRUNCATED
...
@overload  # type hint the return value as `Any` to avoid type checking regressions when using `# CODE_TRUNCATED`.
def Field(
...
def Field(
    ...
    *,
    ...
    json_schema_extra: JsonDict | Callable[[JsonDict], None] | None = _Unset,
    frozen: bool | None = _Unset,
    validate_default: Literal[False] = # CODE_TRUNCATED,
    repr: bool = _Unset,
    init: bool | None = _Unset,
    init_var: bool | None = _Unset,
    kw_only: bool | None = _Unset,
...
@overload
def computed_field(func: PropertyT, /) -> PropertyT: # CODE_TRUNCATED
...
) -> Callable[[PropertyT], PropertyT]: # CODE_TRUNCATED
