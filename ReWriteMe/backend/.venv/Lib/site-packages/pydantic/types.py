...
if TYPE_CHECKING:
    ImportString = Annotated[AnyType, # CODE_TRUNCATED]
else:
...
if TYPE_CHECKING:
    ...
    Json = Annotated[AnyType, # CODE_TRUNCATED]
...
if TYPE_CHECKING:
    PastDate = Annotated[date, # CODE_TRUNCATED]
    FutureDate = Annotated[date, # CODE_TRUNCATED]
else:
...
if TYPE_CHECKING:
    AwareDatetime = Annotated[datetime, # CODE_TRUNCATED]
    NaiveDatetime = Annotated[datetime, # CODE_TRUNCATED]
    PastDatetime = Annotated[datetime, # CODE_TRUNCATED]
    FutureDatetime = Annotated[datetime, # CODE_TRUNCATED]
...
if TYPE_CHECKING:
    ...
    * `None`
    ...
    invalid_json_data = {'j': {'a': {'b': # CODE_TRUNCATED}}}
