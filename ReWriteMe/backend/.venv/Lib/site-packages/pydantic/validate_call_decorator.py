...
if TYPE_CHECKING:
    ...
    AnyCallableT = TypeVar('AnyCallableT', bound=Callable[# CODE_TRUNCATED, Any])
...
@overload
def validate_call(func: AnyCallableT, /) -> AnyCallableT: # CODE_TRUNCATED
...
def validate_call(
    ...
    *,
    ...
    Usage may be either as a plain decorator `@validate_call` or with arguments `@validate_call(# CODE_TRUNCATED)`.
