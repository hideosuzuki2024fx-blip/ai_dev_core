...
if TYPE_CHECKING:
    ...
    SchemaExtraCallable = Callable[# CODE_TRUNCATED, None]
...
if not compiled:
    ...
    class ConfigDict(TypedDict, total=False):
        ...
        keep_untouched: Tuple[type, # CODE_TRUNCATED]
...
class BaseConfig:
    ...
    json_dumps: Callable[# CODE_TRUNCATED, str] = json.dumps
...
def inherit_config(self_config: 'ConfigType', parent_config: 'ConfigType', **namespace: Any) -> 'ConfigType':
    if not self_config:
        base_classes: Tuple['ConfigType', # CODE_TRUNCATED] = (parent_config,)
