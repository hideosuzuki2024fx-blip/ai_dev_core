...
def tuple_validator(v: Any) -> Tuple[Any, # CODE_TRUNCATED]:
...
def make_namedtuple_validator(
...
) -> Callable[[Tuple[Any, # CODE_TRUNCATED]], NamedTupleT]:
    ...
    def namedtuple_validator(values: Tuple[Any, # CODE_TRUNCATED]) -> NamedTupleT:
