...
if TYPE_CHECKING:
    ...
    LocStr = Union[Tuple[Union[int, str], # CODE_TRUNCATED], str]
...
def Field(
    ...
    **extra: Any,
    ...
    :param default: since this is replacing the field’s default, its first argument is used
      to set the default, use ellipsis (``# CODE_TRUNCATED``) to indicate the field is required
...
SHAPE_NAME_LOOKUP = {
    SHAPE_LIST: 'List[{}]',
    SHAPE_SET: 'Set[{}]',
    SHAPE_TUPLE_ELLIPSIS: 'Tuple[{}, # CODE_TRUNCATED]',
...
class ModelField(Representation):
    ...
    def _get_field_info(
        ...
        :param annotation: a type hint such as `str` or `Annotated[str, Field(# CODE_TRUNCATED, min_length=5)]`
        ...
        if get_origin(annotation) is Annotated:
            ...
            if field_info is not None:
                ...
                if value is not Undefined and value is not Required:
                    # check also `Required` because of `validate_arguments` that sets `# CODE_TRUNCATED` as default value
    ...
    def _type_analysis(self) -> None:  # noqa: C901 (ignore complexity)
        ...
        if origin is None or origin is CollectionsHashable:
            ...
            elif len(args) == 2 and args[1] is Ellipsis:  # e.g. Tuple[int, # CODE_TRUNCATED]
                self.type_ = args[0]
                self.shape = SHAPE_TUPLE_ELLIPSIS
    ...
    def prepare_discriminated_union_sub_fields(self) -> None:
        ...
        for sub_field in self.sub_fields:
            ...
            if t.__class__ is ForwardRef:
                # Stopping everything# CODE_TRUNCATEDwill need to call `update_forward_refs`
                return
    ...
    def _validate_sequence_like(  # noqa: C901 (ignore complexity)
        ...
        converted: Union[List[Any], Set[Any], FrozenSet[Any], Tuple[Any, # CODE_TRUNCATED], Iterator[Any], Deque[Any]] = result
    ...
    def _get_mapping_value(self, original: T, converted: Dict[Any, Any]) -> Union[T, Dict[Any, Any]]:
        ...
        if original_cls == dict or original_cls == Dict:
            ...
            try:
                # Counter, OrderedDict, UserDict, # CODE_TRUNCATED
