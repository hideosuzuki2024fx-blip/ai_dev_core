...
We indeed still want to support equality, hashing, repr, # CODE_TRUNCATED as if it was the stdlib one!
...
if TYPE_CHECKING:
    ...
    class Dataclass:
        ...
        __post_init__: ClassVar[Callable[# CODE_TRUNCATED, None]]

        # Added by pydantic
        __pydantic_run_validation__: ClassVar[bool]
        __post_init_post_parse__: ClassVar[Callable[# CODE_TRUNCATED, None]]
