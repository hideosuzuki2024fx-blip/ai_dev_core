...
def _apply_modify_schema(
    modify_schema: Callable[# CODE_TRUNCATED, None], field: Optional[ModelField], field_schema: Dict[str, Any]
) -> None:
...
_str_types_attrs: Tuple[Tuple[str, Union[type, Tuple[type, # CODE_TRUNCATED]], str], # CODE_TRUNCATED] = (
    ('max_length', numeric_types, 'maxLength'),
    ('min_length', numeric_types, 'minLength'),
    ('regex', str, 'pattern'),
)

_numeric_types_attrs: Tuple[Tuple[str, Union[type, Tuple[type, # CODE_TRUNCATED]], str], # CODE_TRUNCATED] = (
...
field_class_to_schema: Tuple[Tuple[Any, Dict[str, Any]], # CODE_TRUNCATED] = (
...
def multitypes_literal_field_for_schema(values: Tuple[Any, # CODE_TRUNCATED], field: ModelField) -> ModelField:
    """
...
_map_types_constraint: Dict[Any, Callable[# CODE_TRUNCATED, type]] = {int: conint, float: confloat, Decimal: condecimal}
...
def get_annotation_with_constraints(annotation: Any, field_info: FieldInfo) -> Tuple[Type[Any], Set[str]]:  # noqa: C901
    ...
    def go(type_: Any) -> Type[Any]:
        ...
        if origin is not None:
            args: Tuple[Any, # CODE_TRUNCATED] = get_args(type_)
        ...
        attrs: Optional[Tuple[str, # CODE_TRUNCATED]] = None
        constraint_func: Optional[Callable[# CODE_TRUNCATED, type]] = None
        ...
        if attrs:
            ...
            if kwargs:
                constraint_func = cast(Callable[# CODE_TRUNCATED, type], constraint_func)
