...
CacheKey = Tuple[Type[Any], Any, Tuple[Any, # CODE_TRUNCATED]]
...
class GenericModel(BaseModel):
    ...
    if TYPE_CHECKING:
        ...
        __parameters__: ClassVar[Tuple[TypeVarType, # CODE_TRUNCATED]]

    # Setting the return type as Type[Any] instead of Type[BaseModel] prevents PyCharm warnings
    def __class_getitem__(cls: Type[GenericModelT], params: Union[Type[Any], Tuple[Type[Any], # CODE_TRUNCATED]]) -> Type[Any]:
    ...
    @classmethod
    def __concrete_name__(cls: Type[Any], params: Tuple[Type[Any], # CODE_TRUNCATED]) -> str:
...
def check_parameters_count(cls: Type[GenericModel], parameters: Tuple[Any, # CODE_TRUNCATED]) -> None:
