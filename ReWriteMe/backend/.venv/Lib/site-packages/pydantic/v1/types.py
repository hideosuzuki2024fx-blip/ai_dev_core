...
# This types superclass should be Set[T], but cython chokes on that# CODE_TRUNCATED
...
# This types superclass should be FrozenSet[T], but cython chokes on that# CODE_TRUNCATED
...
# This types superclass should be List[T], but cython chokes on that# CODE_TRUNCATED
class ConstrainedList(list):  # type: ignore
    # Needed for pydantic to detect that this is a list
    __origin__ = list
    __args__: Tuple[Type[T], # CODE_TRUNCATED]  # type: ignore
...
if TYPE_CHECKING:
    PyObject = Callable[# CODE_TRUNCATED, Any]
else:
...
if TYPE_CHECKING:
    Json = Annotated[T, # CODE_TRUNCATED]  # Json[list[str]] will be recognized by type checkers as list[str]
