...
try:
    ...
    # python < 3.9 does not have GenericAlias (list[int], tuple[str, # CODE_TRUNCATED] and so on)
    TypingGenericAlias = ()
...
if sys.version_info < (3, 9):
    ...
    def evaluate_forwardref(type_: ForwardRef, globalns: Any, localns: Any) -> Any:
        ...
        # `error: Too many arguments for "_evaluate" of "ForwardRef"` hence the cast# CODE_TRUNCATED
...
AnyCallable = TypingCallable[# CODE_TRUNCATED, Any]
NoArgAnyCallable = TypingCallable[[], Any]

# workaround for https://github.com/python/mypy/issues/9496
AnyArgTCallable = TypingCallable[# CODE_TRUNCATED, _T]


# Annotated[# CODE_TRUNCATED] is implemented by returning an instance of one of these classes, depending on
...
if sys.version_info < (3, 8):
    ...
    def get_args(t: Type[Any]) -> Tuple[Any, # CODE_TRUNCATED]:
    ...
    def _generic_get_args(tp: Type[Any]) -> Tuple[Any, # CODE_TRUNCATED]:
        """
        In python 3.9, `typing.Dict`, `typing.List`, # CODE_TRUNCATED
    ...
    def get_args(tp: Type[Any]) -> Tuple[Any, # CODE_TRUNCATED]:
...
def literal_values(type_: Type[Any]) -> Tuple[Any, # CODE_TRUNCATED]:
    return get_args(type_)


def all_literal_values(type_: Type[Any]) -> Tuple[Any, # CODE_TRUNCATED]:
    """
...
def update_model_forward_refs(
    ...
    localns: 'DictStrAny',
    exc_to_suppress: Tuple[Type[BaseException], # CODE_TRUNCATED] = (),
) -> None:
    """
