...
ANNOTATED_FIELD_UNTOUCHED_TYPES: Tuple[Any, # CODE_TRUNCATED] = (property, type, classmethod, staticmethod)
# When creating a `BaseModel` instance, we bypass all the methods, properties# CODE_TRUNCATED added to the model
UNTOUCHED_TYPES: Tuple[Any, # CODE_TRUNCATED] = (FunctionType,) + ANNOTATED_FIELD_UNTOUCHED_TYPES
...
def create_model(
    ...
    *,
    __config__: Optional[Type[BaseConfig]] = None,
    __base__: Union[Type['Model'], Tuple[Type['Model'], # CODE_TRUNCATED]],
    __module__: str = __name__,
    __validators__: Dict[str, 'AnyClassMethod'] = None,
    __cls_kwargs__: Dict[str, Any] = None,
    **field_definitions: Any,
...
def create_model(
    ...
    *,
    __config__: Optional[Type[BaseConfig]] = None,
    __base__: Union[None, Type['Model'], Tuple[Type['Model'], # CODE_TRUNCATED]] = None,
    __module__: str = __name__,
    __validators__: Dict[str, 'AnyClassMethod'] = None,
    __cls_kwargs__: Dict[str, Any] = None,
    __slots__: Optional[Tuple[str, # CODE_TRUNCATED]] = None,
    **field_definitions: Any,
) -> Type['Model']:
    """
    ...
    :param field_definitions: fields of the model (or extra fields if a base is supplied)
        ...
        `foobar=(str, # CODE_TRUNCATED)` or `foobar=123`, or, for complex use-cases, in the format
