...
if TYPE_CHECKING:
    AnyCallable = Callable[# CODE_TRUNCATED, Any]
...
) -> Callable[['AnyCallableT'], 'AnyCallableT']: # CODE_TRUNCATED


@overload
def validate_arguments(func: 'AnyCallableT') -> 'AnyCallableT': # CODE_TRUNCATED
...
class ValidatedFunction:
    def __init__(self, function: 'AnyCallable', config: 'ConfigType'):
        ...
        for i, (name, p) in enumerate(parameters.items()):
            ...
            default = # CODE_TRUNCATED if p.default is p.empty else p.default
            if p.kind == Parameter.POSITIONAL_ONLY:
                ...
                fields[name] = tuple[annotation, # CODE_TRUNCATED], None
                takes_args = True
            else:
    ...
    def build_values(self, args: tuple[Any, # CODE_TRUNCATED], kwargs: dict[str, Any]) -> dict[str, Any]:
        values: dict[str, Any] = {}
        if args:
