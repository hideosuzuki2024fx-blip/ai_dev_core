...
class ValidatorDecoratorInfo:
    ...
    fields: tuple[str, # CODE_TRUNCATED]
...
DecoratedType: TypeAlias = (
    'Union[classmethod[Any, Any, ReturnType], staticmethod[Any, ReturnType], Callable[# CODE_TRUNCATED, ReturnType], property]'
)
...
class PydanticDescriptorProxy(Generic[ReturnType]):
    ...
    shim: Callable[[Callable[# CODE_TRUNCATED, Any]], Callable[# CODE_TRUNCATED, Any]] | None = None
...
class Decorator(Generic[DecoratorInfoType]):
    ...
    cls_ref: str
    cls_var_name: str
    func: Callable[# CODE_TRUNCATED, Any]
...
def get_bases(tp: type[Any]) -> tuple[type[Any], # CODE_TRUNCATED]:
...
def mro(tp: type[Any]) -> tuple[type[Any], # CODE_TRUNCATED]:
...
def mro_for_bases(bases: tuple[type[Any], # CODE_TRUNCATED]) -> tuple[type[Any], # CODE_TRUNCATED]:
...
def get_attribute_from_bases(tp: type[Any] | tuple[type[Any], # CODE_TRUNCATED], name: str) -> Any:
...
def inspect_validator(
    validator: Callable[# CODE_TRUNCATED, Any], *, mode: FieldValidatorModes, type: Literal['field', 'model']
) -> bool:
...
def inspect_field_serializer(serializer: Callable[# CODE_TRUNCATED, Any], mode: Literal['plain', 'wrap']) -> tuple[bool, bool]:
...
def inspect_annotated_serializer(serializer: Callable[# CODE_TRUNCATED, Any], mode: Literal['plain', 'wrap']) -> bool:
...
def inspect_model_serializer(serializer: Callable[# CODE_TRUNCATED, Any], mode: Literal['plain', 'wrap']) -> bool:
...
AnyDecoratorCallable: TypeAlias = (
    'Union[classmethod[Any, Any, Any], staticmethod[Any, Any], partialmethod[Any], Callable[# CODE_TRUNCATED, Any]]'
)
...
def _signature_no_eval(f: Callable[# CODE_TRUNCATED, Any]) -> Signature:
