...
class V1OnlyValueValidator(Protocol):
    ...
    def __call__(self, __value: Any) -> Any: # CODE_TRUNCATED


class V1ValidatorWithValues(Protocol):
    """A validator with `values` argument, supported for V1 validators and V2 validators."""

    def __call__(self, __value: Any, values: dict[str, Any]) -> Any: # CODE_TRUNCATED
...
class V1ValidatorWithKwargs(Protocol):
    ...
    def __call__(self, __value: Any, **kwargs: Any) -> Any: # CODE_TRUNCATED
...
class V1ValidatorWithValuesAndKwargs(Protocol):
    ...
    def __call__(self, __value: Any, values: dict[str, Any], **kwargs: Any) -> Any: # CODE_TRUNCATED
...
RootValidatorFieldsTuple = tuple[Any, # CODE_TRUNCATED]


class V1RootValidatorFunction(Protocol):
    """A simple root validator, supported for V1 validators and V2 validators."""

    def __call__(self, __values: RootValidatorValues) -> RootValidatorValues: # CODE_TRUNCATED


class V2CoreBeforeRootValidator(Protocol):
    """V2 validator with mode='before'."""

    def __call__(self, __values: RootValidatorValues, __info: core_schema.ValidationInfo) -> RootValidatorValues: # CODE_TRUNCATED
...
class V2CoreAfterRootValidator(Protocol):
    ...
    ) -> RootValidatorFieldsTuple: # CODE_TRUNCATED
