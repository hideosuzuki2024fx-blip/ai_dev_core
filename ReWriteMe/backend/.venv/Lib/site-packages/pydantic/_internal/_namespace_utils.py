...
def ns_for_function(obj: Callable[# CODE_TRUNCATED, Any], parent_namespace: MappingNamespace | None = None) -> NamespacesTuple:
    ...
    type_params: tuple[_TypeVarLike, # CODE_TRUNCATED] = getattr(obj, '__type_params__', ())
    if parent_namespace is not None:
...
class NsResolver:
    ...
    def types_namespace(self) -> NamespacesTuple:
        ...
        type_params: tuple[_TypeVarLike, # CODE_TRUNCATED] = getattr(typ, '__type_params__', ())
        if type_params:
