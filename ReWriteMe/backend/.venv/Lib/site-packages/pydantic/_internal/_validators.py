...
def get_defaultdict_default_default_factory(values_source_type: Any) -> Callable[[], Any]:
    ...
    def infer_default() -> Callable[[], Any]:
        ...
        instructions = 'set using `DefaultDict[# CODE_TRUNCATED, Annotated[# CODE_TRUNCATED, Field(default_factory=# CODE_TRUNCATED)]]`'
    ...
    # Assume Annotated[# CODE_TRUNCATED, Field(# CODE_TRUNCATED)]
