...
class ModelMetaclass(ABCMeta):
                ...
                if parameters and parent_parameters and not all(x in parameters for x in parent_parameters):
                    ...
                    if RootModelRootType in parent_parameters and RootModelRootType not in parameters:
                        ...
                        error_message = (
                            ...
                            f'You should parametrize RootModel directly, e.g., `class {cls.__name__}(RootModel[{parameters_str}]): # CODE_TRUNCATED`.'
                        )
                    else:
                        ...
                        if Generic not in bases:  # pragma: no cover
                            ...
                            error_message += (
                                f' Note: `typing.Generic` must go last: `class {cls.__name__}({bases_str}): # CODE_TRUNCATED`)'
                            )
    ...
    @staticmethod
    def _collect_bases_data(bases: tuple[type[Any], # CODE_TRUNCATED]) -> tuple[set[str], set[str], dict[str, ModelPrivateAttr]]:
...
def get_model_post_init(namespace: dict[str, Any], bases: tuple[type[Any], # CODE_TRUNCATED]) -> Callable[# CODE_TRUNCATED, Any] | None:
...
def inspect_namespace(  # noqa C901
    namespace: dict[str, Any],
    raw_annotations: dict[str, Any],
    ignored_types: tuple[type[Any], # CODE_TRUNCATED],
...
def set_default_hash_func(cls: type[BaseModel], bases: tuple[type[Any], # CODE_TRUNCATED]) -> None:
...
@cache
def default_ignored_types() -> tuple[type[Any], # CODE_TRUNCATED]:
