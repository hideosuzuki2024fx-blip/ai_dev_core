...
GenericTypesCacheKey = tuple[Any, Any, tuple[Any, # CODE_TRUNCATED]]
...
# and discover later on that we need to re-add all this infrastructure# CODE_TRUNCATED
...
class PydanticGenericMetadata(TypedDict):
    ...
    args: tuple[Any, # CODE_TRUNCATED]  # analogous to typing._GenericAlias.__args__
    parameters: tuple[TypeVar, # CODE_TRUNCATED]  # analogous to typing.Generic.__parameters__


def create_generic_submodel(
    model_name: str, origin: type[BaseModel], args: tuple[Any, # CODE_TRUNCATED], params: tuple[Any, # CODE_TRUNCATED]
) -> type[BaseModel]:
...
def get_standard_typevars_map(cls: Any) -> dict[TypeVar, Any] | None:
    ...
    args: tuple[Any, # CODE_TRUNCATED] = cls.__args__  # type: ignore
    parameters: tuple[TypeVar, # CODE_TRUNCATED] = origin.__parameters__
...
def map_generic_model_arguments(cls: type[BaseModel], args: tuple[Any, # CODE_TRUNCATED]) -> dict[TypeVar, Any]:
    ...
    Example:
        ...
        class Model[T, U, V = int](BaseModel): # CODE_TRUNCATED
...
def generic_recursion_self_type(
    origin: type[BaseModel], args: tuple[Any, # CODE_TRUNCATED]
...
def get_cached_generic_type_late(
    parent: type[BaseModel], typevar_values: Any, origin: type[BaseModel], args: tuple[Any, # CODE_TRUNCATED]
) -> type[BaseModel] | None:
...
def set_cached_generic_type(
    ...
    typevar_values: tuple[Any, # CODE_TRUNCATED],
    type_: type[BaseModel],
    origin: type[BaseModel] | None = None,
    args: tuple[Any, # CODE_TRUNCATED] | None = None,
) -> None:
...
def _late_cache_key(origin: type[BaseModel], args: tuple[Any, # CODE_TRUNCATED], typevar_values: Any) -> GenericTypesCacheKey:
