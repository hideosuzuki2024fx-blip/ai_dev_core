...
def is_annotated(tp: Any, /) -> bool:
    ...
    is_annotated(Annotated[int, # CODE_TRUNCATED])
    #> True
    ```
    """
...
_NONE_TYPES: tuple[Any, # CODE_TRUNCATED] = (None, NoneType, typing.Literal[None], typing_extensions.Literal[None])
...
if sys.version_info < (3, 10):
    WithArgsTypes: tuple[Any, # CODE_TRUNCATED] = (typing._GenericAlias, types.GenericAlias)  # pyright: ignore[reportAttributeAccessIssue]
else:
    WithArgsTypes: tuple[Any, # CODE_TRUNCATED] = (typing._GenericAlias, types.GenericAlias, types.UnionType)  # pyright: ignore[reportAttributeAccessIssue]
...
def eval_type_backport(
    ...
    globalns: GlobalsNamespace | None = None,
    localns: MappingNamespace | None = None,
    type_params: tuple[Any, # CODE_TRUNCATED] | None = None,
) -> Any:
...
def get_function_type_hints(
    function: Callable[# CODE_TRUNCATED, Any],
    *,
...
if sys.version_info >= (3, 10):
    ...
    def get_type_hints(  # noqa: C901
        ...
        * Use `_make_forward_ref` instead of `typing.ForwardRef` to handle the `is_class` argument.
        ...
        'Annotated[T, # CODE_TRUNCATED]' with 'T' (unless 'include_extras=True').
