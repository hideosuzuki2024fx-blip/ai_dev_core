...
F = t.TypeVar("F", bound="t.Callable[# CODE_TRUNCATED, t.Any]")
V = t.TypeVar("V")
...
def batch(iterable: cabc.Iterable[V], batch_size: int) -> list[tuple[V, # CODE_TRUNCATED]]:
...
class Context:
    ...
    def call_on_close(self, f: t.Callable[# CODE_TRUNCATED, t.Any]) -> t.Callable[# CODE_TRUNCATED, t.Any]:
    ...
    ) -> t.Any | None: # CODE_TRUNCATED

    @t.overload
    def lookup_default(
        self, name: str, call: t.Literal[False] = # CODE_TRUNCATED
    ) -> t.Any | t.Callable[[], t.Any] | None: # CODE_TRUNCATED
    ...
    @t.overload
    def invoke(
        self, callback: t.Callable[# CODE_TRUNCATED, V], /, *args: t.Any, **kwargs: t.Any
    ) -> V: # CODE_TRUNCATED

    @t.overload
    def invoke(self, callback: Command, /, *args: t.Any, **kwargs: t.Any) -> t.Any: # CODE_TRUNCATED

    def invoke(
        self, callback: Command | t.Callable[# CODE_TRUNCATED, V], /, *args: t.Any, **kwargs: t.Any
    ) -> t.Any | V:
        ...
        if isinstance(callback, Command):
            ...
            if other_cmd.callback is None:
                ...
                callback = t.cast("t.Callable[# CODE_TRUNCATED, V]", other_cmd.callback)
...
class Command:
    ...
    def __init__(
        ...
        callback: t.Callable[# CODE_TRUNCATED, t.Any] | None = None,
    ...
    def main(
        ...
        prog_name: str | None = None,
        complete_var: str | None = None,
        standalone_mode: bool = # CODE_TRUNCATED,
        **extra: t.Any,
    ) -> t.Any: # CODE_TRUNCATED
...
class Group(Command):
    ...
    def __init__(
        ...
        chain: bool = False,
        result_callback: t.Callable[# CODE_TRUNCATED, t.Any] | None = None,
        **kwargs: t.Any,
    ) -> None:
        ...
        if subcommand_metavar is None:
            if chain:
                subcommand_metavar = "COMMAND1 [ARGS]# CODE_TRUNCATED [COMMAND2 [ARGS]# CODE_TRUNCATED]# CODE_TRUNCATED"
            else:
                subcommand_metavar = "COMMAND [ARGS]# CODE_TRUNCATED"
    ...
    @t.overload
    def command(self, __func: t.Callable[# CODE_TRUNCATED, t.Any]) -> Command: # CODE_TRUNCATED

    @t.overload
    def command(
        self, *args: t.Any, **kwargs: t.Any
    ) -> t.Callable[[t.Callable[# CODE_TRUNCATED, t.Any]], Command]: # CODE_TRUNCATED

    def command(
        self, *args: t.Any, **kwargs: t.Any
    ) -> t.Callable[[t.Callable[# CODE_TRUNCATED, t.Any]], Command] | Command:
        ...
        func: t.Callable[# CODE_TRUNCATED, t.Any] | None = None
        ...
        def decorator(f: t.Callable[# CODE_TRUNCATED, t.Any]) -> Command:
    ...
    @t.overload
    def group(self, __func: t.Callable[# CODE_TRUNCATED, t.Any]) -> Group: # CODE_TRUNCATED

    @t.overload
    def group(
        self, *args: t.Any, **kwargs: t.Any
    ) -> t.Callable[[t.Callable[# CODE_TRUNCATED, t.Any]], Group]: # CODE_TRUNCATED

    def group(
        self, *args: t.Any, **kwargs: t.Any
    ) -> t.Callable[[t.Callable[# CODE_TRUNCATED, t.Any]], Group] | Group:
        ...
        def decorator(f: t.Callable[# CODE_TRUNCATED, t.Any]) -> Group:
...
class Parameter:
    ...
    @t.overload
    def get_default(
        self, ctx: Context, call: bool = # CODE_TRUNCATED
    ) -> t.Any | t.Callable[[], t.Any] | None: # CODE_TRUNCATED
    ...
    def type_cast_value(self, ctx: Context, value: t.Any) -> t.Any:
        ...
        if self.nargs == 1 or self.type.is_composite:
            ...
            def convert(value: t.Any) -> t.Any:  # tuple[t.Any, # CODE_TRUNCATED]
