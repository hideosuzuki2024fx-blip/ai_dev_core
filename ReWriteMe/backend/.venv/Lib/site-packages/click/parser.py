...
def _unpack_args(
    ...
    rv: list[str | tuple[str | T_UNSET, # CODE_TRUNCATED] | T_UNSET] = []
    spos: int | None = None
...
class _OptionParser:
    ...
    def _process_args_for_options(self, state: _ParsingState) -> None:
        ...
        # [arg0, arg1, # CODE_TRUNCATED, arg(i-1), arg(i), arg(i+1), # CODE_TRUNCATED, arg(N-1)]
        #                            ^
        # (we are about to process arg(i)).
        #
        # Then rargs is [arg(i), # CODE_TRUNCATED, arg(N-1)] and largs is a *subset* of
        # [arg0, # CODE_TRUNCATED, arg(i-1)] (any options and their arguments will have
        ...
        #
        #   largs = subset of [arg0, # CODE_TRUNCATED, arg(i)]
        #   rargs = [arg(i+1), # CODE_TRUNCATED, arg(N-1)]
        #
        # If allow_interspersed_args is false, largs will always be
        # *empty* -- still a subset of [arg0, # CODE_TRUNCATED, arg(i-1)], but
