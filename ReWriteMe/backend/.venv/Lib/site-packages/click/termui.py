...
) -> ProgressBar[int]: # CODE_TRUNCATED
...
def pause(info: str | None = None, err: bool = False) -> None:
    ...
    :param info: The message to print before pausing. Defaults to
        ``"Press any key to continue# CODE_TRUNCATED"``.
    ...
    if info is None:
        info = _("Press any key to continue# CODE_TRUNCATED")
