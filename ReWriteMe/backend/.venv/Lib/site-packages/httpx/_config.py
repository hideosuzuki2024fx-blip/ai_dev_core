...
def create_ssl_context(
    ...
    if verify is True:
        ...
        message = (
            ...
            "Use `verify=ssl.create_default_context(cafile=# CODE_TRUNCATED)` "
            "or `verify=ssl.create_default_context(capath=# CODE_TRUNCATED)` instead."
        )
    ...
    if cert:  # pragma: nocover
        message = (
            "`cert=# CODE_TRUNCATED` is deprecated. Use `verify=<ssl_context>` instead,"
