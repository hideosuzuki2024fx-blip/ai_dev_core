...
# Note# CODE_TRUNCATED The terminology 'userinfo' percent-encode set in the WHATWG document
...
def urlparse(url: str = "", **kwargs: str | None) -> ParseResult:
    ...
    # Ensure that IPv6 "host" addresses are always escaped with "[# CODE_TRUNCATED]".
    if "host" in kwargs:
...
def encode_host(host: str) -> str:
    if not host:
        ...
        # Validate IPv6 hostnames like [# CODE_TRUNCATED]
        #
        # From https://datatracker.ietf.org/doc/html/rfc3986/#section-3.2.2
        #
