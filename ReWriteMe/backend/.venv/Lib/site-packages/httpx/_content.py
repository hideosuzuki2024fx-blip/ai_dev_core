...
def encode_request(
    ...
    if data is not None and not isinstance(data, Mapping):
        ...
        # `data=<bytes# CODE_TRUNCATED>` usages. We deal with that case here, treating it
        # as if `content=<# CODE_TRUNCATED>` had been supplied instead.
        message = "Use 'content=<# CODE_TRUNCATED>' to upload raw bytes/text content."
