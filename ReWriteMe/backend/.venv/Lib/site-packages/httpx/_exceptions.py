...
class HTTPError(Exception):
    ...
    Useful for `try# CODE_TRUNCATEDexcept` blocks when issuing a request,
...
# Timeout exceptions# CODE_TRUNCATED
...
# Core networking exceptions# CODE_TRUNCATED
...
# Other transport exceptions# CODE_TRUNCATED
...
# Other request exceptions# CODE_TRUNCATED
...
class CookieConflict(Exception):
    ...
    Can occur when calling `response.cookies.get(# CODE_TRUNCATED)`.
    """
...
# Stream exceptions# CODE_TRUNCATED
