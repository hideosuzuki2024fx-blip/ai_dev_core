...
def print_help() -> None:
    ...
    table.add_row(
        "-p, --params [cyan]<NAME VALUE> # CODE_TRUNCATED",
    ...
    table.add_row(
        "-d, --data [cyan]<NAME VALUE> # CODE_TRUNCATED", "Form data to include in the request body."
    )
    table.add_row(
        "-f, --files [cyan]<NAME FILENAME> # CODE_TRUNCATED",
        "Form files to include in the request body.",
    )
    table.add_row("-j, --json [cyan]TEXT", "JSON data to include in the request body.")
    table.add_row(
        "-h, --headers [cyan]<NAME VALUE> # CODE_TRUNCATED",
        "Include additional HTTP headers in the request.",
    )
    table.add_row(
        "--cookies [cyan]<NAME VALUE> # CODE_TRUNCATED", "Cookies to include in the request."
    )
    table.add_row(
        "--auth [cyan]<USER PASS>",
    ...
    table.add_row(
        ...
        " connection, reading some data, etc# CODE_TRUNCATED [Default: 5.0]",
    )
...
_PCTRTT = typing.Tuple[typing.Tuple[str, str], # CODE_TRUNCATED]
_PCTRTTT = typing.Tuple[_PCTRTT, # CODE_TRUNCATED]
